...
// []string{"netsec", "service", "v1", "hipprofiles"}
...
import (
    ...
    gDTxIfp "github.com/paloaltonetworks/sase-go/netsec/schema/objects/hip/profiles"
)
...
type CreateInput struct {
    Folder string
    Config gDTxIfp.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/hip-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (gDTxIfp.Config, error) {
    // Variables.
    var err error
    var ans gDTxIfp.Config
    path := "/sse/config/v1/hip-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (gDTxIfp.Config, error) {
    // Variables.
    var err error
    var ans gDTxIfp.Config
    path := "/sse/config/v1/hip-profiles/{id}"
...
type ListOutput struct {
    Data []gDTxIfp.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] gDTxIfp.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] gDTxIfp.Config)
    ...
    listing := make([]gDTxIfp.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (gDTxIfp.Config, error) {
    // Variables.
    var err error
    var ans gDTxIfp.Config
    path := "/sse/config/v1/hip-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (gDTxIfp.Config, error) {
    // Variables.
    var err error
    var ans gDTxIfp.Config
    path := "/sse/config/v1/hip-profiles/{id}"
