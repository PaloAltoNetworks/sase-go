...
import (
	...
	ebgezeM "github.com/paloaltonetworks/sase-go/netsec/schema/objects/hip/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (ebgezeM.Config, error) {
	// Variables.
	var err error
	var ans ebgezeM.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ebgezeM.Config, error) {
	// Variables.
	var err error
	var ans ebgezeM.Config
...
type ListOutput struct {
	Data   []ebgezeM.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ebgezeM.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ebgezeM.Config)
	...
	listing := make([]ebgezeM.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ebgezeM.Config, error) {
	// Variables.
	var err error
	var ans ebgezeM.Config
	path := "/sse/config/v1/hip-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ebgezeM.Config, error) {
	// Variables.
	var err error
	var ans ebgezeM.Config
	path := "/sse/config/v1/hip-profiles/{id}"
