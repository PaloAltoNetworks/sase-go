...
func (c *Client) Create(ctx context.Context, input CreateInput) (yGUJnFs.Config, error) {
	// Variables.
	var err error
	var ans yGUJnFs.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (yGUJnFs.Config, error) {
	// Variables.
	var err error
	var ans yGUJnFs.Config
...
type ListOutput struct {
	Data   []yGUJnFs.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]yGUJnFs.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]yGUJnFs.Config)
	...
	listing := make([]yGUJnFs.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (yGUJnFs.Config, error) {
	// Variables.
	var err error
	var ans yGUJnFs.Config
	path := "/sse/config/v1/hip-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (yGUJnFs.Config, error) {
	// Variables.
	var err error
	var ans yGUJnFs.Config
	path := "/sse/config/v1/hip-profiles/{id}"
