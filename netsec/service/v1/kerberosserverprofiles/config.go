...
func (c *Client) Create(ctx context.Context, input CreateInput) (gOMQArS.Config, error) {
	// Variables.
	var err error
	var ans gOMQArS.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (gOMQArS.Config, error) {
	// Variables.
	var err error
	var ans gOMQArS.Config
...
type ListOutput struct {
	Data   []gOMQArS.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]gOMQArS.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]gOMQArS.Config)
	...
	listing := make([]gOMQArS.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (gOMQArS.Config, error) {
	// Variables.
	var err error
	var ans gOMQArS.Config
	path := "/sse/config/v1/kerberos-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (gOMQArS.Config, error) {
	// Variables.
	var err error
	var ans gOMQArS.Config
	path := "/sse/config/v1/kerberos-server-profiles/{id}"
