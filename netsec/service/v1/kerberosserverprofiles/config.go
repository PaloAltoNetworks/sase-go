...
// []string{"netsec", "service", "v1", "kerberosserverprofiles"}
...
import (
    ...
    yhMOzVN "github.com/paloaltonetworks/sase-go/netsec/schema/kerberos/server/profiles"
)
...
type CreateInput struct {
    Folder string
    Config yhMOzVN.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/kerberos-server-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (yhMOzVN.Config, error) {
    // Variables.
    var err error
    var ans yhMOzVN.Config
    path := "/sse/config/v1/kerberos-server-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (yhMOzVN.Config, error) {
    // Variables.
    var err error
    var ans yhMOzVN.Config
    path := "/sse/config/v1/kerberos-server-profiles/{id}"
...
type ListOutput struct {
    Data []yhMOzVN.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] yhMOzVN.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] yhMOzVN.Config)
    ...
    listing := make([]yhMOzVN.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (yhMOzVN.Config, error) {
    // Variables.
    var err error
    var ans yhMOzVN.Config
    path := "/sse/config/v1/kerberos-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (yhMOzVN.Config, error) {
    // Variables.
    var err error
    var ans yhMOzVN.Config
    path := "/sse/config/v1/kerberos-server-profiles/{id}"
