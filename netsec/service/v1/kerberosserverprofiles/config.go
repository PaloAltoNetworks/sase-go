...
import (
	...
	bntvSLb "github.com/paloaltonetworks/sase-go/netsec/schema/kerberos/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (bntvSLb.Config, error) {
	// Variables.
	var err error
	var ans bntvSLb.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (bntvSLb.Config, error) {
	// Variables.
	var err error
	var ans bntvSLb.Config
...
type ListOutput struct {
	Data   []bntvSLb.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]bntvSLb.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]bntvSLb.Config)
	...
	listing := make([]bntvSLb.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (bntvSLb.Config, error) {
	// Variables.
	var err error
	var ans bntvSLb.Config
	path := "/sse/config/v1/kerberos-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/kerberos-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (bntvSLb.Config, error) {
	// Variables.
	var err error
	var ans bntvSLb.Config
	path := "/sse/config/v1/kerberos-server-profiles/{id}"
