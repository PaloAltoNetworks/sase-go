...
// []string{"netsec", "service", "v1", "urlaccessprofiles"}
...
import (
    ...
    kCrYtol "github.com/paloaltonetworks/sase-go/netsec/schema/url/access/profiles"
)
...
type CreateInput struct {
    Folder string
    Config kCrYtol.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/url-access-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (kCrYtol.Config, error) {
    // Variables.
    var err error
    var ans kCrYtol.Config
    path := "/sse/config/v1/url-access-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (kCrYtol.Config, error) {
    // Variables.
    var err error
    var ans kCrYtol.Config
    path := "/sse/config/v1/url-access-profiles/{id}"
...
type ListOutput struct {
    Data []kCrYtol.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] kCrYtol.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] kCrYtol.Config)
    ...
    listing := make([]kCrYtol.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (kCrYtol.Config, error) {
    // Variables.
    var err error
    var ans kCrYtol.Config
    path := "/sse/config/v1/url-access-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (kCrYtol.Config, error) {
    // Variables.
    var err error
    var ans kCrYtol.Config
    path := "/sse/config/v1/url-access-profiles/{id}"
