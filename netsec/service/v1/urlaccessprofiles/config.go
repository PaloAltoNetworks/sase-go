...
func (c *Client) Create(ctx context.Context, input CreateInput) (wleovFf.Config, error) {
	// Variables.
	var err error
	var ans wleovFf.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (wleovFf.Config, error) {
	// Variables.
	var err error
	var ans wleovFf.Config
...
type ListOutput struct {
	Data   []wleovFf.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]wleovFf.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]wleovFf.Config)
	...
	listing := make([]wleovFf.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (wleovFf.Config, error) {
	// Variables.
	var err error
	var ans wleovFf.Config
	path := "/sse/config/v1/url-access-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (wleovFf.Config, error) {
	// Variables.
	var err error
	var ans wleovFf.Config
	path := "/sse/config/v1/url-access-profiles/{id}"
