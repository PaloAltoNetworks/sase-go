...
import (
	...
	bPFvpdj "github.com/paloaltonetworks/sase-go/netsec/schema/url/access/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (bPFvpdj.Config, error) {
	// Variables.
	var err error
	var ans bPFvpdj.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (bPFvpdj.Config, error) {
	// Variables.
	var err error
	var ans bPFvpdj.Config
...
type ListOutput struct {
	Data   []bPFvpdj.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]bPFvpdj.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]bPFvpdj.Config)
	...
	listing := make([]bPFvpdj.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (bPFvpdj.Config, error) {
	// Variables.
	var err error
	var ans bPFvpdj.Config
	path := "/sse/config/v1/url-access-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/url-access-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (bPFvpdj.Config, error) {
	// Variables.
	var err error
	var ans bPFvpdj.Config
	path := "/sse/config/v1/url-access-profiles/{id}"
