...
// []string{"netsec", "service", "v1", "services"}
...
import (
    ...
    vCQKQdZ "github.com/paloaltonetworks/sase-go/netsec/schema/objects/services"
)
...
type CreateInput struct {
    Folder string
    Config vCQKQdZ.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/services
func (c *Client) Create(ctx context.Context, input CreateInput)  (vCQKQdZ.Config, error) {
    // Variables.
    var err error
    var ans vCQKQdZ.Config
...
//
// Method: delete
// URI: /sse/config/v1/services/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (vCQKQdZ.Config, error) {
    // Variables.
    var err error
    var ans vCQKQdZ.Config
    path := "/sse/config/v1/services/{id}"
...
type ListOutput struct {
    Data []vCQKQdZ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] vCQKQdZ.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] vCQKQdZ.Config)
    ...
    listing := make([]vCQKQdZ.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/services/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (vCQKQdZ.Config, error) {
    // Variables.
    var err error
    var ans vCQKQdZ.Config
    path := "/sse/config/v1/services/{id}"
...
// Method: put
// URI: /sse/config/v1/services/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (vCQKQdZ.Config, error) {
    // Variables.
    var err error
    var ans vCQKQdZ.Config
    path := "/sse/config/v1/services/{id}"
