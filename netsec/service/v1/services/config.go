...
import (
	...
	vwYhvOI "github.com/paloaltonetworks/sase-go/netsec/schema/objects/services"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (vwYhvOI.Config, error) {
	// Variables.
	var err error
	var ans vwYhvOI.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vwYhvOI.Config, error) {
	// Variables.
	var err error
	var ans vwYhvOI.Config
...
type ListOutput struct {
	Data   []vwYhvOI.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vwYhvOI.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vwYhvOI.Config)
	...
	listing := make([]vwYhvOI.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/services/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vwYhvOI.Config, error) {
	// Variables.
	var err error
	var ans vwYhvOI.Config
	path := "/sse/config/v1/services/{id}"
...
// Method: put
// URI: /sse/config/v1/services/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vwYhvOI.Config, error) {
	// Variables.
	var err error
	var ans vwYhvOI.Config
	path := "/sse/config/v1/services/{id}"
