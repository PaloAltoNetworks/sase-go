...
func (c *Client) Create(ctx context.Context, input CreateInput) (ktjCEnF.Config, error) {
	// Variables.
	var err error
	var ans ktjCEnF.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ktjCEnF.Config, error) {
	// Variables.
	var err error
	var ans ktjCEnF.Config
...
type ListOutput struct {
	Data   []ktjCEnF.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ktjCEnF.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ktjCEnF.Config)
	...
	listing := make([]ktjCEnF.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/services/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ktjCEnF.Config, error) {
	// Variables.
	var err error
	var ans ktjCEnF.Config
	path := "/sse/config/v1/services/{id}"
...
// Method: put
// URI: /sse/config/v1/services/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ktjCEnF.Config, error) {
	// Variables.
	var err error
	var ans ktjCEnF.Config
	path := "/sse/config/v1/services/{id}"
