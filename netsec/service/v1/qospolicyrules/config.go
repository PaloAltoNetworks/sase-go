...
import (
    ...
    vXkPhAi "github.com/paloaltonetworks/sase-go/netsec/schema/qos/policy/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (vXkPhAi.Config, error) {
    // Variables.
    var err error
    var ans vXkPhAi.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (vXkPhAi.Config, error) {
    // Variables.
    var err error
    var ans vXkPhAi.Config
...
type ListOutput struct {
    Data []vXkPhAi.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] vXkPhAi.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] vXkPhAi.Config)
    ...
    listing := make([]vXkPhAi.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (vXkPhAi.Config, error) {
    // Variables.
    var err error
    var ans vXkPhAi.Config
    path := "/sse/config/v1/qos-policy-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (vXkPhAi.Config, error) {
    // Variables.
    var err error
    var ans vXkPhAi.Config
    path := "/sse/config/v1/qos-policy-rules/{id}"
