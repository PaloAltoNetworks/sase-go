...
func (c *Client) Create(ctx context.Context, input CreateInput) (lNsAvVs.Config, error) {
	// Variables.
	var err error
	var ans lNsAvVs.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (lNsAvVs.Config, error) {
	// Variables.
	var err error
	var ans lNsAvVs.Config
...
type ListOutput struct {
	Data   []lNsAvVs.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]lNsAvVs.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]lNsAvVs.Config)
	...
	listing := make([]lNsAvVs.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (lNsAvVs.Config, error) {
	// Variables.
	var err error
	var ans lNsAvVs.Config
	path := "/sse/config/v1/qos-policy-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (lNsAvVs.Config, error) {
	// Variables.
	var err error
	var ans lNsAvVs.Config
	path := "/sse/config/v1/qos-policy-rules/{id}"
