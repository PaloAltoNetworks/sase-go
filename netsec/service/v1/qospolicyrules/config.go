...
// []string{"netsec", "service", "v1", "qospolicyrules"}
...
import (
	...
	rNUYnBc "github.com/paloaltonetworks/sase-go/netsec/schema/qos/policy/rules"
)
...
// path: []string{}
// query: []string{"folder", "position"}
type CreateInput struct {
	Folder   string
	Position string
	Config   rNUYnBc.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/qos-policy-rules
func (c *Client) Create(ctx context.Context, input CreateInput) (rNUYnBc.Config, error) {
	// Variables.
	var err error
	var ans rNUYnBc.Config
	path := "/sse/config/v1/qos-policy-rules"
...
//
// Method: delete
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (rNUYnBc.Config, error) {
	// Variables.
	var err error
	var ans rNUYnBc.Config
	path := "/sse/config/v1/qos-policy-rules/{id}"
...
// path: []string{}
// query: []string{"limit-optional", "offset-optional", "name-optional", "folder", "position"}
...
type ListOutput struct {
	Data   []rNUYnBc.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]rNUYnBc.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]rNUYnBc.Config)
	...
	listing := make([]rNUYnBc.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (rNUYnBc.Config, error) {
	// Variables.
	var err error
	var ans rNUYnBc.Config
	path := "/sse/config/v1/qos-policy-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/qos-policy-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (rNUYnBc.Config, error) {
	// Variables.
	var err error
	var ans rNUYnBc.Config
	path := "/sse/config/v1/qos-policy-rules/{id}"
