...
import (
    ...
    jBujDNB "github.com/paloaltonetworks/sase-go/netsec/schema/objects/application/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (jBujDNB.Config, error) {
    // Variables.
    var err error
    var ans jBujDNB.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (jBujDNB.Config, error) {
    // Variables.
    var err error
    var ans jBujDNB.Config
...
type ListOutput struct {
    Data []jBujDNB.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] jBujDNB.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] jBujDNB.Config)
    ...
    listing := make([]jBujDNB.Config, 0, len(items))
    for key := range items {
...
type PutInputConfig struct {
    Entry jBujDNB.Config `json:"entry,omitempty"`
}
...
// Method: get
// URI: /sse/config/v1/application-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (jBujDNB.Config, error) {
    // Variables.
    var err error
    var ans jBujDNB.Config
    path := "/sse/config/v1/application-groups/{id}"
