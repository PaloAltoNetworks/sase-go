...
// []string{"netsec", "service", "v1", "applicationgroups"}
...
import (
	...
	jKAbxdv "github.com/paloaltonetworks/sase-go/netsec/schema/objects/application/groups"
)
...
type CreateInput struct {
	Folder string
	Config jKAbxdv.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/application-groups
func (c *Client) Create(ctx context.Context, input CreateInput) (jKAbxdv.Config, error) {
	// Variables.
	var err error
	var ans jKAbxdv.Config
	path := "/sse/config/v1/application-groups"
...
//
// Method: delete
// URI: /sse/config/v1/application-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (jKAbxdv.Config, error) {
	// Variables.
	var err error
	var ans jKAbxdv.Config
	path := "/sse/config/v1/application-groups/{id}"
...
type ListOutput struct {
	Data   []jKAbxdv.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]jKAbxdv.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]jKAbxdv.Config)
	...
	listing := make([]jKAbxdv.Config, 0, len(items))
	for key := range items {
...
Param Entry (): The Entry param. Instance of Config.
*/
type PutInputConfig struct {
	Entry jKAbxdv.Config `json:"entry,omitempty"`
}

// Put performs a the given operation.
//
// Method: put
// URI: /sse/config/v1/application-groups/{id}
...
// Method: get
// URI: /sse/config/v1/application-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (jKAbxdv.Config, error) {
	// Variables.
	var err error
	var ans jKAbxdv.Config
	path := "/sse/config/v1/application-groups/{id}"
