...
// []string{"netsec", "service", "v1", "addresses"}
...
import (
	...
	xfWlKMB "github.com/paloaltonetworks/sase-go/netsec/schema/objects/addresses"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (xfWlKMB.Config, error) {
	// Variables.
	var err error
	var ans xfWlKMB.Config
...
//
// Method: delete
// URI: /sse/config/v1/addresses/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (xfWlKMB.Config, error) {
	// Variables.
	var err error
	var ans xfWlKMB.Config
...
type ListOutput struct {
	Data   []xfWlKMB.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]xfWlKMB.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]xfWlKMB.Config)
	...
	listing := make([]xfWlKMB.Config, 0, len(items))
	for key := range items {
...
// query: []string{}
//
// NOTE(gfreeman): Folder added as the schema is incorrect.
...
// Method: get
// URI: /sse/config/v1/addresses/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (xfWlKMB.Config, error) {
	// Variables.
	var err error
	var ans xfWlKMB.Config
	path := "/sse/config/v1/addresses/{id}"
...
// Method: put
// URI: /sse/config/v1/addresses/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (xfWlKMB.Config, error) {
	// Variables.
	var err error
	var ans xfWlKMB.Config
	path := "/sse/config/v1/addresses/{id}"
