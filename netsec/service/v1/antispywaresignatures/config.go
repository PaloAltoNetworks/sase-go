...
import (
	...
	uIHLJPY "github.com/paloaltonetworks/sase-go/netsec/schema/anti/spyware/signatures"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (uIHLJPY.Config, error) {
	// Variables.
	var err error
	var ans uIHLJPY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (uIHLJPY.Config, error) {
	// Variables.
	var err error
	var ans uIHLJPY.Config
...
type ListOutput struct {
	Data   []uIHLJPY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]uIHLJPY.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]uIHLJPY.Config)
	...
	listing := make([]uIHLJPY.Config, 0, len(items))
	for key := range items {
...
// Method: put
// URI: /sse/config/v1/anti-spyware-signatures/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (uIHLJPY.Config, error) {
	// Variables.
	var err error
	var ans uIHLJPY.Config
	path := "/sse/config/v1/anti-spyware-signatures/{id}"
