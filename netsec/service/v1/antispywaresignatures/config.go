...
// []string{"netsec", "service", "v1", "antispywaresignatures"}
...
import (
	...
	glSmTlf "github.com/paloaltonetworks/sase-go/netsec/schema/anti/spyware/signatures"
)
...
type CreateInput struct {
	Folder string
	Config glSmTlf.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/anti-spyware-signatures
func (c *Client) Create(ctx context.Context, input CreateInput) (glSmTlf.Config, error) {
	// Variables.
	var err error
	var ans glSmTlf.Config
	path := "/sse/config/v1/anti-spyware-signatures"
...
//
// Method: delete
// URI: /sse/config/v1/anti-spyware-signatures/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (glSmTlf.Config, error) {
	// Variables.
	var err error
	var ans glSmTlf.Config
	path := "/sse/config/v1/anti-spyware-signatures/{id}"
...
type ListOutput struct {
	Data   []glSmTlf.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]glSmTlf.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]glSmTlf.Config)
	...
	listing := make([]glSmTlf.Config, 0, len(items))
	for key := range items {
...
// Method: put
// URI: /sse/config/v1/anti-spyware-signatures/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (glSmTlf.Config, error) {
	// Variables.
	var err error
	var ans glSmTlf.Config
	path := "/sse/config/v1/anti-spyware-signatures/{id}"
