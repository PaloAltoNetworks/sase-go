...
import (
    ...
    cntzDFU "github.com/paloaltonetworks/sase-go/netsec/schema/anti/spyware/signatures"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (cntzDFU.Config, error) {
    // Variables.
    var err error
    var ans cntzDFU.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (cntzDFU.Config, error) {
    // Variables.
    var err error
    var ans cntzDFU.Config
...
type ListOutput struct {
    Data []cntzDFU.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] cntzDFU.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] cntzDFU.Config)
    ...
    listing := make([]cntzDFU.Config, 0, len(items))
    for key := range items {
...
// Method: put
// URI: /sse/config/v1/anti-spyware-signatures/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (cntzDFU.Config, error) {
    // Variables.
    var err error
    var ans cntzDFU.Config
    path := "/sse/config/v1/anti-spyware-signatures/{id}"
