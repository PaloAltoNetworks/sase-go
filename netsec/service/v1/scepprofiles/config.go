...
import (
    ...
    sJfOsqA "github.com/paloaltonetworks/sase-go/netsec/schema/scep/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (sJfOsqA.Config, error) {
    // Variables.
    var err error
    var ans sJfOsqA.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (sJfOsqA.Config, error) {
    // Variables.
    var err error
    var ans sJfOsqA.Config
...
type ListOutput struct {
    Data []sJfOsqA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] sJfOsqA.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] sJfOsqA.Config)
    ...
    listing := make([]sJfOsqA.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (sJfOsqA.Config, error) {
    // Variables.
    var err error
    var ans sJfOsqA.Config
    path := "/sse/config/v1/scep-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (sJfOsqA.Config, error) {
    // Variables.
    var err error
    var ans sJfOsqA.Config
    path := "/sse/config/v1/scep-profiles/{id}"
