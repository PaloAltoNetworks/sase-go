...
func (c *Client) Create(ctx context.Context, input CreateInput) (qmgDayz.Config, error) {
	// Variables.
	var err error
	var ans qmgDayz.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (qmgDayz.Config, error) {
	// Variables.
	var err error
	var ans qmgDayz.Config
...
type ListOutput struct {
	Data   []qmgDayz.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]qmgDayz.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]qmgDayz.Config)
	...
	listing := make([]qmgDayz.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (qmgDayz.Config, error) {
	// Variables.
	var err error
	var ans qmgDayz.Config
	path := "/sse/config/v1/scep-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (qmgDayz.Config, error) {
	// Variables.
	var err error
	var ans qmgDayz.Config
	path := "/sse/config/v1/scep-profiles/{id}"
