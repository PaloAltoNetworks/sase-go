...
// []string{"netsec", "service", "v1", "scepprofiles"}
...
import (
	...
	ieNdsNJ "github.com/paloaltonetworks/sase-go/netsec/schema/scep/profiles"
)
...
type CreateInput struct {
	Type   string
	Config ieNdsNJ.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/scep-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (ieNdsNJ.Config, error) {
	// Variables.
	var err error
	var ans ieNdsNJ.Config
	path := "/sse/config/v1/scep-profiles"

	// Query parameter handling.
	uv := url.Values{}
	uv.Set("type", input.Type)
...
//
// Method: delete
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ieNdsNJ.Config, error) {
	// Variables.
	var err error
	var ans ieNdsNJ.Config
	path := "/sse/config/v1/scep-profiles/{id}"
...
type ListOutput struct {
	Data   []ieNdsNJ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ieNdsNJ.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ieNdsNJ.Config)
	...
	listing := make([]ieNdsNJ.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ieNdsNJ.Config, error) {
	// Variables.
	var err error
	var ans ieNdsNJ.Config
	path := "/sse/config/v1/scep-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/scep-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ieNdsNJ.Config, error) {
	// Variables.
	var err error
	var ans ieNdsNJ.Config
	path := "/sse/config/v1/scep-profiles/{id}"
