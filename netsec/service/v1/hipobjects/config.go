...
// []string{"netsec", "service", "v1", "hipobjects"}
...
import (
    ...
    yiEpqKF "github.com/paloaltonetworks/sase-go/netsec/schema/objects/hip/objects"
)
...
type CreateInput struct {
    Folder string
    Config yiEpqKF.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/hip-objects
func (c *Client) Create(ctx context.Context, input CreateInput)  (yiEpqKF.Config, error) {
    // Variables.
    var err error
    var ans yiEpqKF.Config
    path := "/sse/config/v1/hip-objects"
...
//
// Method: delete
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (yiEpqKF.Config, error) {
    // Variables.
    var err error
    var ans yiEpqKF.Config
    path := "/sse/config/v1/hip-objects/{id}"
...
type ListOutput struct {
    Data []yiEpqKF.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] yiEpqKF.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] yiEpqKF.Config)
    ...
    listing := make([]yiEpqKF.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (yiEpqKF.Config, error) {
    // Variables.
    var err error
    var ans yiEpqKF.Config
    path := "/sse/config/v1/hip-objects/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (yiEpqKF.Config, error) {
    // Variables.
    var err error
    var ans yiEpqKF.Config
    path := "/sse/config/v1/hip-objects/{id}"
