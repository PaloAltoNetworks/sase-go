...
func (c *Client) Create(ctx context.Context, input CreateInput) (dJpBrWV.Config, error) {
	// Variables.
	var err error
	var ans dJpBrWV.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (dJpBrWV.Config, error) {
	// Variables.
	var err error
	var ans dJpBrWV.Config
...
type ListOutput struct {
	Data   []dJpBrWV.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]dJpBrWV.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]dJpBrWV.Config)
	...
	listing := make([]dJpBrWV.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (dJpBrWV.Config, error) {
	// Variables.
	var err error
	var ans dJpBrWV.Config
	path := "/sse/config/v1/hip-objects/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (dJpBrWV.Config, error) {
	// Variables.
	var err error
	var ans dJpBrWV.Config
	path := "/sse/config/v1/hip-objects/{id}"
