...
import (
	...
	luAwnCg "github.com/paloaltonetworks/sase-go/netsec/schema/objects/hip/objects"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (luAwnCg.Config, error) {
	// Variables.
	var err error
	var ans luAwnCg.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (luAwnCg.Config, error) {
	// Variables.
	var err error
	var ans luAwnCg.Config
...
type ListOutput struct {
	Data   []luAwnCg.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]luAwnCg.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]luAwnCg.Config)
	...
	listing := make([]luAwnCg.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (luAwnCg.Config, error) {
	// Variables.
	var err error
	var ans luAwnCg.Config
	path := "/sse/config/v1/hip-objects/{id}"
...
// Method: put
// URI: /sse/config/v1/hip-objects/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (luAwnCg.Config, error) {
	// Variables.
	var err error
	var ans luAwnCg.Config
	path := "/sse/config/v1/hip-objects/{id}"
