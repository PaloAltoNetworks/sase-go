...
// []string{"netsec", "service", "v1", "serviceconnections"}
...
import (
	...
	aACmfsa "github.com/paloaltonetworks/sase-go/netsec/schema/service/connections"
)
...
type CreateInput struct {
	Folder string
	Config aACmfsa.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/service-connections
func (c *Client) Create(ctx context.Context, input CreateInput) (aACmfsa.Config, error) {
	// Variables.
	var err error
	var ans aACmfsa.Config
	path := "/sse/config/v1/service-connections"
...
//
// Method: delete
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (aACmfsa.Config, error) {
	// Variables.
	var err error
	var ans aACmfsa.Config
	path := "/sse/config/v1/service-connections/{id}"
...
type ListOutput struct {
	Data   []aACmfsa.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]aACmfsa.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]aACmfsa.Config)
	...
	listing := make([]aACmfsa.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (aACmfsa.Config, error) {
	// Variables.
	var err error
	var ans aACmfsa.Config
	path := "/sse/config/v1/service-connections/{id}"
...
// Method: put
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (aACmfsa.Config, error) {
	// Variables.
	var err error
	var ans aACmfsa.Config
	path := "/sse/config/v1/service-connections/{id}"
