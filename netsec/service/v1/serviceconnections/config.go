...
import (
    ...
    mvNxQtY "github.com/paloaltonetworks/sase-go/netsec/schema/service/connections"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (mvNxQtY.Config, error) {
    // Variables.
    var err error
    var ans mvNxQtY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (mvNxQtY.Config, error) {
    // Variables.
    var err error
    var ans mvNxQtY.Config
...
type ListOutput struct {
    Data []mvNxQtY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] mvNxQtY.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] mvNxQtY.Config)
    ...
    listing := make([]mvNxQtY.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (mvNxQtY.Config, error) {
    // Variables.
    var err error
    var ans mvNxQtY.Config
    path := "/sse/config/v1/service-connections/{id}"
...
// Method: put
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (mvNxQtY.Config, error) {
    // Variables.
    var err error
    var ans mvNxQtY.Config
    path := "/sse/config/v1/service-connections/{id}"
