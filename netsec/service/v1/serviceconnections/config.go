...
import (
    ...
    bvMZSjb "github.com/paloaltonetworks/sase-go/netsec/schema/service/connections"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (bvMZSjb.Config, error) {
    // Variables.
    var err error
    var ans bvMZSjb.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (bvMZSjb.Config, error) {
    // Variables.
    var err error
    var ans bvMZSjb.Config
...
type ListOutput struct {
    Data []bvMZSjb.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] bvMZSjb.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] bvMZSjb.Config)
    ...
    listing := make([]bvMZSjb.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (bvMZSjb.Config, error) {
    // Variables.
    var err error
    var ans bvMZSjb.Config
    path := "/sse/config/v1/service-connections/{id}"
...
// Method: put
// URI: /sse/config/v1/service-connections/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (bvMZSjb.Config, error) {
    // Variables.
    var err error
    var ans bvMZSjb.Config
    path := "/sse/config/v1/service-connections/{id}"
