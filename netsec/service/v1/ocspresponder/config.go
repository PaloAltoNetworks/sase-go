...
func (c *Client) Create(ctx context.Context, input CreateInput) (ctlHcHg.Config, error) {
	// Variables.
	var err error
	var ans ctlHcHg.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ctlHcHg.Config, error) {
	// Variables.
	var err error
	var ans ctlHcHg.Config
...
type ListOutput struct {
	Data   []ctlHcHg.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ctlHcHg.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ctlHcHg.Config)
	...
	listing := make([]ctlHcHg.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ocsp-responder/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ctlHcHg.Config, error) {
	// Variables.
	var err error
	var ans ctlHcHg.Config
	path := "/sse/config/v1/ocsp-responder/{id}"
...
// Method: put
// URI: /sse/config/v1/ocsp-responder/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ctlHcHg.Config, error) {
	// Variables.
	var err error
	var ans ctlHcHg.Config
	path := "/sse/config/v1/ocsp-responder/{id}"
