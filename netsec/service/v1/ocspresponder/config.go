...
import (
    ...
    cOvMOpj "github.com/paloaltonetworks/sase-go/netsec/schema/ocsp/responder"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (cOvMOpj.Config, error) {
    // Variables.
    var err error
    var ans cOvMOpj.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (cOvMOpj.Config, error) {
    // Variables.
    var err error
    var ans cOvMOpj.Config
...
type ListOutput struct {
    Data []cOvMOpj.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] cOvMOpj.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] cOvMOpj.Config)
    ...
    listing := make([]cOvMOpj.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ocsp-responder/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (cOvMOpj.Config, error) {
    // Variables.
    var err error
    var ans cOvMOpj.Config
    path := "/sse/config/v1/ocsp-responder/{id}"
...
// Method: put
// URI: /sse/config/v1/ocsp-responder/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (cOvMOpj.Config, error) {
    // Variables.
    var err error
    var ans cOvMOpj.Config
    path := "/sse/config/v1/ocsp-responder/{id}"
