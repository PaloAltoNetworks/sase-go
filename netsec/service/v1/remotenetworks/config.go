...
import (
	...
	wfEoKEO "github.com/paloaltonetworks/sase-go/netsec/schema/remote/networks"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (wfEoKEO.Config, error) {
	// Variables.
	var err error
	var ans wfEoKEO.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (wfEoKEO.Config, error) {
	// Variables.
	var err error
	var ans wfEoKEO.Config
...
type ListOutput struct {
	Data   []wfEoKEO.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]wfEoKEO.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]wfEoKEO.Config)
	...
	listing := make([]wfEoKEO.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/remote-networks/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (wfEoKEO.Config, error) {
	// Variables.
	var err error
	var ans wfEoKEO.Config
	path := "/sse/config/v1/remote-networks/{id}"
...
// Method: put
// URI: /sse/config/v1/remote-networks/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (wfEoKEO.Config, error) {
	// Variables.
	var err error
	var ans wfEoKEO.Config
	path := "/sse/config/v1/remote-networks/{id}"
