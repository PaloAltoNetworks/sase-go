...
import (
	...
	ouWlbPA "github.com/paloaltonetworks/sase-go/netsec/schema/radius/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (ouWlbPA.Config, error) {
	// Variables.
	var err error
	var ans ouWlbPA.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ouWlbPA.Config, error) {
	// Variables.
	var err error
	var ans ouWlbPA.Config
...
type ListOutput struct {
	Data   []ouWlbPA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ouWlbPA.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ouWlbPA.Config)
	...
	listing := make([]ouWlbPA.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/radius-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ouWlbPA.Config, error) {
	// Variables.
	var err error
	var ans ouWlbPA.Config
	path := "/sse/config/v1/radius-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/radius-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ouWlbPA.Config, error) {
	// Variables.
	var err error
	var ans ouWlbPA.Config
	path := "/sse/config/v1/radius-server-profiles/{id}"
