...
import (
    ...
    qAjyWrY "github.com/paloaltonetworks/sase-go/netsec/schema/radius/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (qAjyWrY.Config, error) {
    // Variables.
    var err error
    var ans qAjyWrY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (qAjyWrY.Config, error) {
    // Variables.
    var err error
    var ans qAjyWrY.Config
...
type ListOutput struct {
    Data []qAjyWrY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] qAjyWrY.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] qAjyWrY.Config)
    ...
    listing := make([]qAjyWrY.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/radius-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (qAjyWrY.Config, error) {
    // Variables.
    var err error
    var ans qAjyWrY.Config
    path := "/sse/config/v1/radius-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/radius-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (qAjyWrY.Config, error) {
    // Variables.
    var err error
    var ans qAjyWrY.Config
    path := "/sse/config/v1/radius-server-profiles/{id}"
