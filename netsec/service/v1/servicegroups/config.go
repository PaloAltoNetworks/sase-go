...
import (
	...
	mPjgFDJ "github.com/paloaltonetworks/sase-go/netsec/schema/objects/service/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (mPjgFDJ.Config, error) {
	// Variables.
	var err error
	var ans mPjgFDJ.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mPjgFDJ.Config, error) {
	// Variables.
	var err error
	var ans mPjgFDJ.Config
...
type ListOutput struct {
	Data   []mPjgFDJ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]mPjgFDJ.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]mPjgFDJ.Config)
	...
	listing := make([]mPjgFDJ.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mPjgFDJ.Config, error) {
	// Variables.
	var err error
	var ans mPjgFDJ.Config
	path := "/sse/config/v1/service-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mPjgFDJ.Config, error) {
	// Variables.
	var err error
	var ans mPjgFDJ.Config
	path := "/sse/config/v1/service-groups/{id}"
