...
// []string{"netsec", "service", "v1", "servicegroups"}
...
import (
    ...
    gacKfPM "github.com/paloaltonetworks/sase-go/netsec/schema/objects/service/groups"
)
...
type CreateInput struct {
    Folder string
    Config gacKfPM.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/service-groups
func (c *Client) Create(ctx context.Context, input CreateInput)  (gacKfPM.Config, error) {
    // Variables.
    var err error
    var ans gacKfPM.Config
    path := "/sse/config/v1/service-groups"
...
//
// Method: delete
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (gacKfPM.Config, error) {
    // Variables.
    var err error
    var ans gacKfPM.Config
    path := "/sse/config/v1/service-groups/{id}"
...
type ListOutput struct {
    Data []gacKfPM.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] gacKfPM.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] gacKfPM.Config)
    ...
    listing := make([]gacKfPM.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (gacKfPM.Config, error) {
    // Variables.
    var err error
    var ans gacKfPM.Config
    path := "/sse/config/v1/service-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (gacKfPM.Config, error) {
    // Variables.
    var err error
    var ans gacKfPM.Config
    path := "/sse/config/v1/service-groups/{id}"
