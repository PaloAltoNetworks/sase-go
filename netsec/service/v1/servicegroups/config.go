...
func (c *Client) Create(ctx context.Context, input CreateInput) (rTHVQOB.Config, error) {
	// Variables.
	var err error
	var ans rTHVQOB.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (rTHVQOB.Config, error) {
	// Variables.
	var err error
	var ans rTHVQOB.Config
...
type ListOutput struct {
	Data   []rTHVQOB.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]rTHVQOB.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]rTHVQOB.Config)
	...
	listing := make([]rTHVQOB.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (rTHVQOB.Config, error) {
	// Variables.
	var err error
	var ans rTHVQOB.Config
	path := "/sse/config/v1/service-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/service-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (rTHVQOB.Config, error) {
	// Variables.
	var err error
	var ans rTHVQOB.Config
	path := "/sse/config/v1/service-groups/{id}"
