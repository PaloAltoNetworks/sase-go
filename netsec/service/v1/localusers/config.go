...
func (c *Client) Create(ctx context.Context, input CreateInput) (jOMmLLT.Config, error) {
	// Variables.
	var err error
	var ans jOMmLLT.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (jOMmLLT.Config, error) {
	// Variables.
	var err error
	var ans jOMmLLT.Config
...
type ListOutput struct {
	Data   []jOMmLLT.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]jOMmLLT.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]jOMmLLT.Config)
	...
	listing := make([]jOMmLLT.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (jOMmLLT.Config, error) {
	// Variables.
	var err error
	var ans jOMmLLT.Config
	path := "/sse/config/v1/local-users/{id}"
...
// Method: put
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (jOMmLLT.Config, error) {
	// Variables.
	var err error
	var ans jOMmLLT.Config
	path := "/sse/config/v1/local-users/{id}"
