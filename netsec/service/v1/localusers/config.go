...
// []string{"netsec", "service", "v1", "localusers"}
...
import (
    ...
    rIFSrAR "github.com/paloaltonetworks/sase-go/netsec/schema/local/users"
)
...
type CreateInput struct {
    Folder string
    Config rIFSrAR.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/local-users
func (c *Client) Create(ctx context.Context, input CreateInput)  (rIFSrAR.Config, error) {
    // Variables.
    var err error
    var ans rIFSrAR.Config
    path := "/sse/config/v1/local-users"
...
//
// Method: delete
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (rIFSrAR.Config, error) {
    // Variables.
    var err error
    var ans rIFSrAR.Config
    path := "/sse/config/v1/local-users/{id}"
...
type ListOutput struct {
    Data []rIFSrAR.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] rIFSrAR.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] rIFSrAR.Config)
    ...
    listing := make([]rIFSrAR.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (rIFSrAR.Config, error) {
    // Variables.
    var err error
    var ans rIFSrAR.Config
    path := "/sse/config/v1/local-users/{id}"
...
// Method: put
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (rIFSrAR.Config, error) {
    // Variables.
    var err error
    var ans rIFSrAR.Config
    path := "/sse/config/v1/local-users/{id}"
