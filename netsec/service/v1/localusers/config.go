...
import (
	...
	vUFikTo "github.com/paloaltonetworks/sase-go/netsec/schema/local/users"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (vUFikTo.Config, error) {
	// Variables.
	var err error
	var ans vUFikTo.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vUFikTo.Config, error) {
	// Variables.
	var err error
	var ans vUFikTo.Config
...
type ListOutput struct {
	Data   []vUFikTo.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vUFikTo.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vUFikTo.Config)
	...
	listing := make([]vUFikTo.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vUFikTo.Config, error) {
	// Variables.
	var err error
	var ans vUFikTo.Config
	path := "/sse/config/v1/local-users/{id}"
...
// Method: put
// URI: /sse/config/v1/local-users/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vUFikTo.Config, error) {
	// Variables.
	var err error
	var ans vUFikTo.Config
	path := "/sse/config/v1/local-users/{id}"
