...
import (
    ...
    zkKsbhX "github.com/paloaltonetworks/sase-go/netsec/schema/objects/schedules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (zkKsbhX.Config, error) {
    // Variables.
    var err error
    var ans zkKsbhX.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (zkKsbhX.Config, error) {
    // Variables.
    var err error
    var ans zkKsbhX.Config
...
type ListOutput struct {
    Data []zkKsbhX.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] zkKsbhX.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] zkKsbhX.Config)
    ...
    listing := make([]zkKsbhX.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/schedules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (zkKsbhX.Config, error) {
    // Variables.
    var err error
    var ans zkKsbhX.Config
    path := "/sse/config/v1/schedules/{id}"
...
// Method: put
// URI: /sse/config/v1/schedules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (zkKsbhX.Config, error) {
    // Variables.
    var err error
    var ans zkKsbhX.Config
    path := "/sse/config/v1/schedules/{id}"
