...
import (
	...
	eLjcOXm "github.com/paloaltonetworks/sase-go/netsec/schema/objects/schedules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (eLjcOXm.Config, error) {
	// Variables.
	var err error
	var ans eLjcOXm.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (eLjcOXm.Config, error) {
	// Variables.
	var err error
	var ans eLjcOXm.Config
...
type ListOutput struct {
	Data   []eLjcOXm.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]eLjcOXm.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]eLjcOXm.Config)
	...
	listing := make([]eLjcOXm.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/schedules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (eLjcOXm.Config, error) {
	// Variables.
	var err error
	var ans eLjcOXm.Config
	path := "/sse/config/v1/schedules/{id}"
...
// Method: put
// URI: /sse/config/v1/schedules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (eLjcOXm.Config, error) {
	// Variables.
	var err error
	var ans eLjcOXm.Config
	path := "/sse/config/v1/schedules/{id}"
