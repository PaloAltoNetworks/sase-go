...
import (
    ...
    dPpGNCA "github.com/paloaltonetworks/sase-go/netsec/schema/ldap/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (dPpGNCA.Config, error) {
    // Variables.
    var err error
    var ans dPpGNCA.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (dPpGNCA.Config, error) {
    // Variables.
    var err error
    var ans dPpGNCA.Config
...
type ListOutput struct {
    Data []dPpGNCA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] dPpGNCA.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] dPpGNCA.Config)
    ...
    listing := make([]dPpGNCA.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ldap-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (dPpGNCA.Config, error) {
    // Variables.
    var err error
    var ans dPpGNCA.Config
    path := "/sse/config/v1/ldap-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ldap-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (dPpGNCA.Config, error) {
    // Variables.
    var err error
    var ans dPpGNCA.Config
    path := "/sse/config/v1/ldap-server-profiles/{id}"
