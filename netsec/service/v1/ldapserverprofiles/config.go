...
import (
	...
	xmQbEEM "github.com/paloaltonetworks/sase-go/netsec/schema/ldap/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (xmQbEEM.Config, error) {
	// Variables.
	var err error
	var ans xmQbEEM.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (xmQbEEM.Config, error) {
	// Variables.
	var err error
	var ans xmQbEEM.Config
...
type ListOutput struct {
	Data   []xmQbEEM.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]xmQbEEM.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]xmQbEEM.Config)
	...
	listing := make([]xmQbEEM.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ldap-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (xmQbEEM.Config, error) {
	// Variables.
	var err error
	var ans xmQbEEM.Config
	path := "/sse/config/v1/ldap-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ldap-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (xmQbEEM.Config, error) {
	// Variables.
	var err error
	var ans xmQbEEM.Config
	path := "/sse/config/v1/ldap-server-profiles/{id}"
