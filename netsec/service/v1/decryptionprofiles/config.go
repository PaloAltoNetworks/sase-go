...
func (c *Client) Create(ctx context.Context, input CreateInput) (vMYBRZK.Config, error) {
	// Variables.
	var err error
	var ans vMYBRZK.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vMYBRZK.Config, error) {
	// Variables.
	var err error
	var ans vMYBRZK.Config
...
type ListOutput struct {
	Data   []vMYBRZK.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vMYBRZK.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vMYBRZK.Config)
	...
	listing := make([]vMYBRZK.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vMYBRZK.Config, error) {
	// Variables.
	var err error
	var ans vMYBRZK.Config
	path := "/sse/config/v1/decryption-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vMYBRZK.Config, error) {
	// Variables.
	var err error
	var ans vMYBRZK.Config
	path := "/sse/config/v1/decryption-profiles/{id}"
