...
// []string{"netsec", "service", "v1", "decryptionprofiles"}
...
import (
    ...
    syHOmGq "github.com/paloaltonetworks/sase-go/netsec/schema/decryption/profiles"
)
...
type CreateInput struct {
    Folder string
    Config syHOmGq.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/decryption-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (syHOmGq.Config, error) {
    // Variables.
    var err error
    var ans syHOmGq.Config
    path := "/sse/config/v1/decryption-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (syHOmGq.Config, error) {
    // Variables.
    var err error
    var ans syHOmGq.Config
    path := "/sse/config/v1/decryption-profiles/{id}"
...
type ListOutput struct {
    Data []syHOmGq.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] syHOmGq.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] syHOmGq.Config)
    ...
    listing := make([]syHOmGq.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (syHOmGq.Config, error) {
    // Variables.
    var err error
    var ans syHOmGq.Config
    path := "/sse/config/v1/decryption-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (syHOmGq.Config, error) {
    // Variables.
    var err error
    var ans syHOmGq.Config
    path := "/sse/config/v1/decryption-profiles/{id}"
