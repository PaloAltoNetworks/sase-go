...
import (
	...
	eSPYLVC "github.com/paloaltonetworks/sase-go/netsec/schema/decryption/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (eSPYLVC.Config, error) {
	// Variables.
	var err error
	var ans eSPYLVC.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (eSPYLVC.Config, error) {
	// Variables.
	var err error
	var ans eSPYLVC.Config
...
type ListOutput struct {
	Data   []eSPYLVC.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]eSPYLVC.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]eSPYLVC.Config)
	...
	listing := make([]eSPYLVC.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (eSPYLVC.Config, error) {
	// Variables.
	var err error
	var ans eSPYLVC.Config
	path := "/sse/config/v1/decryption-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (eSPYLVC.Config, error) {
	// Variables.
	var err error
	var ans eSPYLVC.Config
	path := "/sse/config/v1/decryption-profiles/{id}"
