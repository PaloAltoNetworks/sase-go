...
func (c *Client) Create(ctx context.Context, input CreateInput) (xNwmFxK.Config, error) {
	// Variables.
	var err error
	var ans xNwmFxK.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (xNwmFxK.Config, error) {
	// Variables.
	var err error
	var ans xNwmFxK.Config
...
type ListOutput struct {
	Data   []xNwmFxK.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]xNwmFxK.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]xNwmFxK.Config)
	...
	listing := make([]xNwmFxK.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (xNwmFxK.Config, error) {
	// Variables.
	var err error
	var ans xNwmFxK.Config
	path := "/sse/config/v1/authentication-sequences/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (xNwmFxK.Config, error) {
	// Variables.
	var err error
	var ans xNwmFxK.Config
	path := "/sse/config/v1/authentication-sequences/{id}"
