...
// []string{"netsec", "service", "v1", "authenticationsequences"}
...
import (
    ...
    klyFMdA "github.com/paloaltonetworks/sase-go/netsec/schema/authentication/sequences"
)
...
type CreateInput struct {
    Folder string
    Config klyFMdA.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/authentication-sequences
func (c *Client) Create(ctx context.Context, input CreateInput)  (klyFMdA.Config, error) {
    // Variables.
    var err error
    var ans klyFMdA.Config
    path := "/sse/config/v1/authentication-sequences"
...
//
// Method: delete
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (klyFMdA.Config, error) {
    // Variables.
    var err error
    var ans klyFMdA.Config
    path := "/sse/config/v1/authentication-sequences/{id}"
...
type ListOutput struct {
    Data []klyFMdA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] klyFMdA.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] klyFMdA.Config)
    ...
    listing := make([]klyFMdA.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (klyFMdA.Config, error) {
    // Variables.
    var err error
    var ans klyFMdA.Config
    path := "/sse/config/v1/authentication-sequences/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (klyFMdA.Config, error) {
    // Variables.
    var err error
    var ans klyFMdA.Config
    path := "/sse/config/v1/authentication-sequences/{id}"
