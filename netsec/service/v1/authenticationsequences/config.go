...
import (
	...
	rFGtIsJ "github.com/paloaltonetworks/sase-go/netsec/schema/authentication/sequences"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (rFGtIsJ.Config, error) {
	// Variables.
	var err error
	var ans rFGtIsJ.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (rFGtIsJ.Config, error) {
	// Variables.
	var err error
	var ans rFGtIsJ.Config
...
type ListOutput struct {
	Data   []rFGtIsJ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]rFGtIsJ.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]rFGtIsJ.Config)
	...
	listing := make([]rFGtIsJ.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (rFGtIsJ.Config, error) {
	// Variables.
	var err error
	var ans rFGtIsJ.Config
	path := "/sse/config/v1/authentication-sequences/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-sequences/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (rFGtIsJ.Config, error) {
	// Variables.
	var err error
	var ans rFGtIsJ.Config
	path := "/sse/config/v1/authentication-sequences/{id}"
