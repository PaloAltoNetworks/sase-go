...
import (
    ...
    nMYSWVY "github.com/paloaltonetworks/sase-go/netsec/schema/authentication/portals"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (nMYSWVY.Config, error) {
    // Variables.
    var err error
    var ans nMYSWVY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (nMYSWVY.Config, error) {
    // Variables.
    var err error
    var ans nMYSWVY.Config
...
type ListOutput struct {
    Data []nMYSWVY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] nMYSWVY.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] nMYSWVY.Config)
    ...
    listing := make([]nMYSWVY.Config, 0, len(items))
    for key := range items {
...
// Method: put
// URI: /sse/config/v1/authentication-portals/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (nMYSWVY.Config, error) {
    // Variables.
    var err error
    var ans nMYSWVY.Config
    path := "/sse/config/v1/authentication-portals/{id}"
