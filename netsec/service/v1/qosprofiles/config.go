...
import (
    ...
    iKTOhFe "github.com/paloaltonetworks/sase-go/netsec/schema/qos/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (iKTOhFe.Config, error) {
    // Variables.
    var err error
    var ans iKTOhFe.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (iKTOhFe.Config, error) {
    // Variables.
    var err error
    var ans iKTOhFe.Config
...
type ListOutput struct {
    Data []iKTOhFe.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] iKTOhFe.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] iKTOhFe.Config)
    ...
    listing := make([]iKTOhFe.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/qos-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (iKTOhFe.Config, error) {
    // Variables.
    var err error
    var ans iKTOhFe.Config
    path := "/sse/config/v1/qos-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/qos-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (iKTOhFe.Config, error) {
    // Variables.
    var err error
    var ans iKTOhFe.Config
    path := "/sse/config/v1/qos-profiles/{id}"
