...
func (c *Client) Create(ctx context.Context, input CreateInput) (ngmdzgb.Config, error) {
	// Variables.
	var err error
	var ans ngmdzgb.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ngmdzgb.Config, error) {
	// Variables.
	var err error
	var ans ngmdzgb.Config
...
type ListOutput struct {
	Data   []ngmdzgb.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]ngmdzgb.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]ngmdzgb.Config)
	...
	listing := make([]ngmdzgb.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/qos-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ngmdzgb.Config, error) {
	// Variables.
	var err error
	var ans ngmdzgb.Config
	path := "/sse/config/v1/qos-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/qos-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ngmdzgb.Config, error) {
	// Variables.
	var err error
	var ans ngmdzgb.Config
	path := "/sse/config/v1/qos-profiles/{id}"
