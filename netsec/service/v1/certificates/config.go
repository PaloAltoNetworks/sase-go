...
// []string{"netsec", "service", "v1", "certificates"}
...
import (
	...
	yKjHHuj "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/get"
	mqGlZpL "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/imprt"
)
...
type CreateInput struct {
	Folder string
	Config mqGlZpL.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/certificates:import
func (c *Client) Create(ctx context.Context, input CreateInput) (mqGlZpL.Config, error) {
	// Variables.
	var err error
	var ans mqGlZpL.Config
	path := "/sse/config/v1/certificates:import"
...
//
// Method: delete
// URI: /sse/config/v1/certificates/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mqGlZpL.Config, error) {
	// Variables.
	var err error
	var ans mqGlZpL.Config
	path := "/sse/config/v1/certificates/{id}"
...
type ListOutput struct {
	Data   []yKjHHuj.Config `json:"data,omitempty"`
...
//
// Method: get
// URI: /sse/config/v1/certificates
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]yKjHHuj.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]yKjHHuj.Config)
	...
	listing := make([]yKjHHuj.Config, 0, len(items))
	for key := range items {
