...
import (
	...
	cBiswpr "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/get"
	vqtUUHF "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/imprt"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (vqtUUHF.Config, error) {
	// Variables.
	var err error
	var ans vqtUUHF.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vqtUUHF.Config, error) {
	// Variables.
	var err error
	var ans vqtUUHF.Config
...
type ListOutput struct {
	Data   []cBiswpr.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]cBiswpr.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]cBiswpr.Config)
	...
	listing := make([]cBiswpr.Config, 0, len(items))
	for key := range items {
