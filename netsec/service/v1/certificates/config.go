...
import (
    ...
    yRqyBhG "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/imprt"
    zQIjzLh "github.com/paloaltonetworks/sase-go/netsec/schema/certificates/get"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (yRqyBhG.Config, error) {
    // Variables.
    var err error
    var ans yRqyBhG.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (yRqyBhG.Config, error) {
    // Variables.
    var err error
    var ans yRqyBhG.Config
...
type ListOutput struct {
    Data []zQIjzLh.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] zQIjzLh.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] zQIjzLh.Config)
    ...
    listing := make([]zQIjzLh.Config, 0, len(items))
    for key := range items {
