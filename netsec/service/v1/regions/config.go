...
// []string{"netsec", "service", "v1", "regions"}
...
import (
	...
	lnEAyuc "github.com/paloaltonetworks/sase-go/netsec/schema/objects/regions"
)
...
type CreateInput struct {
	Folder string
	Config lnEAyuc.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/regions
func (c *Client) Create(ctx context.Context, input CreateInput) (lnEAyuc.Config, error) {
	// Variables.
	var err error
	var ans lnEAyuc.Config
	path := "/sse/config/v1/regions"
...
//
// Method: delete
// URI: /sse/config/v1/regions/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (lnEAyuc.Config, error) {
	// Variables.
	var err error
	var ans lnEAyuc.Config
	path := "/sse/config/v1/regions/{id}"
...
type ListOutput struct {
	Data   []lnEAyuc.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]lnEAyuc.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]lnEAyuc.Config)
	...
	listing := make([]lnEAyuc.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/regions/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (lnEAyuc.Config, error) {
	// Variables.
	var err error
	var ans lnEAyuc.Config
	path := "/sse/config/v1/regions/{id}"
...
// Method: put
// URI: /sse/config/v1/regions/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (lnEAyuc.Config, error) {
	// Variables.
	var err error
	var ans lnEAyuc.Config
	path := "/sse/config/v1/regions/{id}"
