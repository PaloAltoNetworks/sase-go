...
import (
    ...
    barSnVu "github.com/paloaltonetworks/sase-go/netsec/schema/objects/regions"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (barSnVu.Config, error) {
    // Variables.
    var err error
    var ans barSnVu.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (barSnVu.Config, error) {
    // Variables.
    var err error
    var ans barSnVu.Config
...
type ListOutput struct {
    Data []barSnVu.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] barSnVu.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] barSnVu.Config)
    ...
    listing := make([]barSnVu.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/regions/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (barSnVu.Config, error) {
    // Variables.
    var err error
    var ans barSnVu.Config
    path := "/sse/config/v1/regions/{id}"
...
// Method: put
// URI: /sse/config/v1/regions/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (barSnVu.Config, error) {
    // Variables.
    var err error
    var ans barSnVu.Config
    path := "/sse/config/v1/regions/{id}"
