...
import (
	...
	zbwtYlC "github.com/paloaltonetworks/sase-go/netsec/schema/license/types"
)
...
func (c *Client) LicenseTypesGet(ctx context.Context) (zbwtYlC.Config, error) {
	// Variables.
	var err error
	var ans zbwtYlC.Config
