...
import (
	...
	wAlaEvP "github.com/paloaltonetworks/sase-go/netsec/schema/file/blocking/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (wAlaEvP.Config, error) {
	// Variables.
	var err error
	var ans wAlaEvP.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (wAlaEvP.Config, error) {
	// Variables.
	var err error
	var ans wAlaEvP.Config
...
type ListOutput struct {
	Data   []wAlaEvP.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]wAlaEvP.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]wAlaEvP.Config)
	...
	listing := make([]wAlaEvP.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/file-blocking-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (wAlaEvP.Config, error) {
	// Variables.
	var err error
	var ans wAlaEvP.Config
	path := "/sse/config/v1/file-blocking-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/file-blocking-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (wAlaEvP.Config, error) {
	// Variables.
	var err error
	var ans wAlaEvP.Config
	path := "/sse/config/v1/file-blocking-profiles/{id}"
