...
func (c *Client) Create(ctx context.Context, input CreateInput) (wMgZmmI.Config, error) {
	// Variables.
	var err error
	var ans wMgZmmI.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (wMgZmmI.Config, error) {
	// Variables.
	var err error
	var ans wMgZmmI.Config
...
type ListOutput struct {
	Data   []wMgZmmI.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]wMgZmmI.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]wMgZmmI.Config)
	...
	listing := make([]wMgZmmI.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/file-blocking-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (wMgZmmI.Config, error) {
	// Variables.
	var err error
	var ans wMgZmmI.Config
	path := "/sse/config/v1/file-blocking-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/file-blocking-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (wMgZmmI.Config, error) {
	// Variables.
	var err error
	var ans wMgZmmI.Config
	path := "/sse/config/v1/file-blocking-profiles/{id}"
