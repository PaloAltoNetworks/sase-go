...
// []string{"netsec", "service", "v1", "profilegroups"}
...
import (
    ...
    oLvbPgP "github.com/paloaltonetworks/sase-go/netsec/schema/profile/groups"
)
...
type CreateInput struct {
    Folder string
    Config oLvbPgP.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/profile-groups
func (c *Client) Create(ctx context.Context, input CreateInput)  (oLvbPgP.Config, error) {
    // Variables.
    var err error
    var ans oLvbPgP.Config
    path := "/sse/config/v1/profile-groups"
...
//
// Method: delete
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (oLvbPgP.Config, error) {
    // Variables.
    var err error
    var ans oLvbPgP.Config
    path := "/sse/config/v1/profile-groups/{id}"
...
type ListOutput struct {
    Data []oLvbPgP.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] oLvbPgP.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] oLvbPgP.Config)
    ...
    listing := make([]oLvbPgP.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (oLvbPgP.Config, error) {
    // Variables.
    var err error
    var ans oLvbPgP.Config
    path := "/sse/config/v1/profile-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (oLvbPgP.Config, error) {
    // Variables.
    var err error
    var ans oLvbPgP.Config
    path := "/sse/config/v1/profile-groups/{id}"
