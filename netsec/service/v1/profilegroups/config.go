...
import (
	...
	xUPjENf "github.com/paloaltonetworks/sase-go/netsec/schema/profile/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (xUPjENf.Config, error) {
	// Variables.
	var err error
	var ans xUPjENf.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (xUPjENf.Config, error) {
	// Variables.
	var err error
	var ans xUPjENf.Config
...
type ListOutput struct {
	Data   []xUPjENf.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]xUPjENf.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]xUPjENf.Config)
	...
	listing := make([]xUPjENf.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (xUPjENf.Config, error) {
	// Variables.
	var err error
	var ans xUPjENf.Config
	path := "/sse/config/v1/profile-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (xUPjENf.Config, error) {
	// Variables.
	var err error
	var ans xUPjENf.Config
	path := "/sse/config/v1/profile-groups/{id}"
