...
func (c *Client) Create(ctx context.Context, input CreateInput) (mQehIbG.Config, error) {
	// Variables.
	var err error
	var ans mQehIbG.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mQehIbG.Config, error) {
	// Variables.
	var err error
	var ans mQehIbG.Config
...
type ListOutput struct {
	Data   []mQehIbG.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]mQehIbG.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]mQehIbG.Config)
	...
	listing := make([]mQehIbG.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mQehIbG.Config, error) {
	// Variables.
	var err error
	var ans mQehIbG.Config
	path := "/sse/config/v1/profile-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/profile-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mQehIbG.Config, error) {
	// Variables.
	var err error
	var ans mQehIbG.Config
	path := "/sse/config/v1/profile-groups/{id}"
