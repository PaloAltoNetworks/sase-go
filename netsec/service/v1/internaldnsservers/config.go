...
// []string{"netsec", "service", "v1", "internaldnsservers"}
...
import (
	...
	irwjrye "github.com/paloaltonetworks/sase-go/netsec/schema/internal/dns/servers"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (irwjrye.Config, error) {
	// Variables.
	var err error
	var ans irwjrye.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (irwjrye.Config, error) {
	// Variables.
	var err error
	var ans irwjrye.Config
...
// Method: get
// URI: /sse/config/v1/internal-dns-servers
func (c *Client) InternalDnsServersGet(ctx context.Context, input InternalDnsServersGetInput) (irwjrye.Config, error) {
	// Variables.
	var err error
	var ans irwjrye.Config
	path := "/sse/config/v1/internal-dns-servers"
...
// Method: get
// URI: /sse/config/v1/internal-dns-servers/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (irwjrye.Config, error) {
	// Variables.
	var err error
	var ans irwjrye.Config
	path := "/sse/config/v1/internal-dns-servers/{id}"
...
// Method: put
// URI: /sse/config/v1/internal-dns-servers/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (irwjrye.Config, error) {
	// Variables.
	var err error
	var ans irwjrye.Config
	path := "/sse/config/v1/internal-dns-servers/{id}"
