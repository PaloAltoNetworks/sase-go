...
// []string{"netsec", "service", "v1", "securityrules"}
...
import (
	...
	zgFyImu "github.com/paloaltonetworks/sase-go/netsec/schema/security/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (zgFyImu.Config, error) {
	// Variables.
	var err error
	var ans zgFyImu.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (zgFyImu.Config, error) {
	// Variables.
	var err error
	var ans zgFyImu.Config
...
type ListOutput struct {
	Data   []zgFyImu.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]zgFyImu.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]zgFyImu.Config)
	...
	listing := make([]zgFyImu.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/security-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (zgFyImu.Config, error) {
	// Variables.
	var err error
	var ans zgFyImu.Config
	path := "/sse/config/v1/security-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/security-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (zgFyImu.Config, error) {
	// Variables.
	var err error
	var ans zgFyImu.Config
	path := "/sse/config/v1/security-rules/{id}"
