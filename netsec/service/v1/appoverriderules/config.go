...
import (
	...
	gawASSz "github.com/paloaltonetworks/sase-go/netsec/schema/app/override/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (gawASSz.Config, error) {
	// Variables.
	var err error
	var ans gawASSz.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (gawASSz.Config, error) {
	// Variables.
	var err error
	var ans gawASSz.Config
...
type ListOutput struct {
	Data   []gawASSz.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]gawASSz.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]gawASSz.Config)
	...
	listing := make([]gawASSz.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/app-override-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (gawASSz.Config, error) {
	// Variables.
	var err error
	var ans gawASSz.Config
	path := "/sse/config/v1/app-override-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/app-override-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (gawASSz.Config, error) {
	// Variables.
	var err error
	var ans gawASSz.Config
	path := "/sse/config/v1/app-override-rules/{id}"
