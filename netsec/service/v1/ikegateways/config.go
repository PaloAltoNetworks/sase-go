...
import (
	...
	pPvrKXP "github.com/paloaltonetworks/sase-go/netsec/schema/ike/gateways"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (pPvrKXP.Config, error) {
	// Variables.
	var err error
	var ans pPvrKXP.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (pPvrKXP.Config, error) {
	// Variables.
	var err error
	var ans pPvrKXP.Config
...
type ListOutput struct {
	Data   []pPvrKXP.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]pPvrKXP.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]pPvrKXP.Config)
	...
	listing := make([]pPvrKXP.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ike-gateways/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (pPvrKXP.Config, error) {
	// Variables.
	var err error
	var ans pPvrKXP.Config
	path := "/sse/config/v1/ike-gateways/{id}"
...
// Method: put
// URI: /sse/config/v1/ike-gateways/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (pPvrKXP.Config, error) {
	// Variables.
	var err error
	var ans pPvrKXP.Config
	path := "/sse/config/v1/ike-gateways/{id}"
