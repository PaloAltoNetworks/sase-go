...
// []string{"netsec", "service", "v1", "ikegateways"}
...
import (
    ...
    dMfmVdJ "github.com/paloaltonetworks/sase-go/netsec/schema/ike/gateways"
)
...
type CreateInput struct {
    Folder string
    Config dMfmVdJ.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/ike-gateways
func (c *Client) Create(ctx context.Context, input CreateInput)  (dMfmVdJ.Config, error) {
    // Variables.
    var err error
    var ans dMfmVdJ.Config
    path := "/sse/config/v1/ike-gateways"
...
//
// Method: delete
// URI: /sse/config/v1/ike-gateways/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (dMfmVdJ.Config, error) {
    // Variables.
    var err error
    var ans dMfmVdJ.Config
    path := "/sse/config/v1/ike-gateways/{id}"
...
type ListOutput struct {
    Data []dMfmVdJ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] dMfmVdJ.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] dMfmVdJ.Config)
    ...
    listing := make([]dMfmVdJ.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ike-gateways/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (dMfmVdJ.Config, error) {
    // Variables.
    var err error
    var ans dMfmVdJ.Config
    path := "/sse/config/v1/ike-gateways/{id}"
...
// Method: put
// URI: /sse/config/v1/ike-gateways/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (dMfmVdJ.Config, error) {
    // Variables.
    var err error
    var ans dMfmVdJ.Config
    path := "/sse/config/v1/ike-gateways/{id}"
