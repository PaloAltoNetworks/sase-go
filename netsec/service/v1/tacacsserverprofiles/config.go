...
// []string{"netsec", "service", "v1", "tacacsserverprofiles"}
...
import (
	...
	vvcvSaV "github.com/paloaltonetworks/sase-go/netsec/schema/tacacs/server/profiles"
)
...
type CreateInput struct {
	Folder string
	Config vvcvSaV.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/tacacs-server-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (vvcvSaV.Config, error) {
	// Variables.
	var err error
	var ans vvcvSaV.Config
	path := "/sse/config/v1/tacacs-server-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vvcvSaV.Config, error) {
	// Variables.
	var err error
	var ans vvcvSaV.Config
	path := "/sse/config/v1/tacacs-server-profiles/{id}"
...
type ListOutput struct {
	Data   []vvcvSaV.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vvcvSaV.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vvcvSaV.Config)
	...
	listing := make([]vvcvSaV.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vvcvSaV.Config, error) {
	// Variables.
	var err error
	var ans vvcvSaV.Config
	path := "/sse/config/v1/tacacs-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vvcvSaV.Config, error) {
	// Variables.
	var err error
	var ans vvcvSaV.Config
	path := "/sse/config/v1/tacacs-server-profiles/{id}"
