...
func (c *Client) Create(ctx context.Context, input CreateInput) (fWrszss.Config, error) {
	// Variables.
	var err error
	var ans fWrszss.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fWrszss.Config, error) {
	// Variables.
	var err error
	var ans fWrszss.Config
...
type ListOutput struct {
	Data   []fWrszss.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]fWrszss.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]fWrszss.Config)
	...
	listing := make([]fWrszss.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fWrszss.Config, error) {
	// Variables.
	var err error
	var ans fWrszss.Config
	path := "/sse/config/v1/tacacs-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fWrszss.Config, error) {
	// Variables.
	var err error
	var ans fWrszss.Config
	path := "/sse/config/v1/tacacs-server-profiles/{id}"
