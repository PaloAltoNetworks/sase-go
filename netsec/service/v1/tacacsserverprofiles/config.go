...
import (
    ...
    mppKdhS "github.com/paloaltonetworks/sase-go/netsec/schema/tacacs/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (mppKdhS.Config, error) {
    // Variables.
    var err error
    var ans mppKdhS.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (mppKdhS.Config, error) {
    // Variables.
    var err error
    var ans mppKdhS.Config
...
type ListOutput struct {
    Data []mppKdhS.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] mppKdhS.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] mppKdhS.Config)
    ...
    listing := make([]mppKdhS.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (mppKdhS.Config, error) {
    // Variables.
    var err error
    var ans mppKdhS.Config
    path := "/sse/config/v1/tacacs-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/tacacs-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (mppKdhS.Config, error) {
    // Variables.
    var err error
    var ans mppKdhS.Config
    path := "/sse/config/v1/tacacs-server-profiles/{id}"
