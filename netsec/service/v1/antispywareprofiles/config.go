...
func (c *Client) Create(ctx context.Context, input CreateInput) (fZwFwyb.Config, error) {
	// Variables.
	var err error
	var ans fZwFwyb.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fZwFwyb.Config, error) {
	// Variables.
	var err error
	var ans fZwFwyb.Config
...
type ListOutput struct {
	Data   []fZwFwyb.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]fZwFwyb.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]fZwFwyb.Config)
	...
	listing := make([]fZwFwyb.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fZwFwyb.Config, error) {
	// Variables.
	var err error
	var ans fZwFwyb.Config
	path := "/sse/config/v1/anti-spyware-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fZwFwyb.Config, error) {
	// Variables.
	var err error
	var ans fZwFwyb.Config
	path := "/sse/config/v1/anti-spyware-profiles/{id}"
