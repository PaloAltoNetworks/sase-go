...
import (
	...
	zRaZpgL "github.com/paloaltonetworks/sase-go/netsec/schema/anti/spyware/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (zRaZpgL.Config, error) {
	// Variables.
	var err error
	var ans zRaZpgL.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (zRaZpgL.Config, error) {
	// Variables.
	var err error
	var ans zRaZpgL.Config
...
type ListOutput struct {
	Data   []zRaZpgL.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]zRaZpgL.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]zRaZpgL.Config)
	...
	listing := make([]zRaZpgL.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (zRaZpgL.Config, error) {
	// Variables.
	var err error
	var ans zRaZpgL.Config
	path := "/sse/config/v1/anti-spyware-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (zRaZpgL.Config, error) {
	// Variables.
	var err error
	var ans zRaZpgL.Config
	path := "/sse/config/v1/anti-spyware-profiles/{id}"
