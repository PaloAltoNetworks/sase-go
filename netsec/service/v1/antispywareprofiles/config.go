...
// []string{"netsec", "service", "v1", "antispywareprofiles"}
...
import (
    ...
    ohPIJPD "github.com/paloaltonetworks/sase-go/netsec/schema/anti/spyware/profiles"
)
...
type CreateInput struct {
    Folder string
    Config ohPIJPD.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/anti-spyware-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (ohPIJPD.Config, error) {
    // Variables.
    var err error
    var ans ohPIJPD.Config
    path := "/sse/config/v1/anti-spyware-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (ohPIJPD.Config, error) {
    // Variables.
    var err error
    var ans ohPIJPD.Config
    path := "/sse/config/v1/anti-spyware-profiles/{id}"
...
type ListOutput struct {
    Data []ohPIJPD.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] ohPIJPD.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] ohPIJPD.Config)
    ...
    listing := make([]ohPIJPD.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (ohPIJPD.Config, error) {
    // Variables.
    var err error
    var ans ohPIJPD.Config
    path := "/sse/config/v1/anti-spyware-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/anti-spyware-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (ohPIJPD.Config, error) {
    // Variables.
    var err error
    var ans ohPIJPD.Config
    path := "/sse/config/v1/anti-spyware-profiles/{id}"
