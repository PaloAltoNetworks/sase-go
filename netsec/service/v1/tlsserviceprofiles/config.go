...
import (
	...
	rftIqIZ "github.com/paloaltonetworks/sase-go/netsec/schema/tls/service/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (rftIqIZ.Config, error) {
	// Variables.
	var err error
	var ans rftIqIZ.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (rftIqIZ.Config, error) {
	// Variables.
	var err error
	var ans rftIqIZ.Config
...
type ListOutput struct {
	Data   []rftIqIZ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]rftIqIZ.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]rftIqIZ.Config)
	...
	listing := make([]rftIqIZ.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/tls-service-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (rftIqIZ.Config, error) {
	// Variables.
	var err error
	var ans rftIqIZ.Config
	path := "/sse/config/v1/tls-service-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/tls-service-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (rftIqIZ.Config, error) {
	// Variables.
	var err error
	var ans rftIqIZ.Config
	path := "/sse/config/v1/tls-service-profiles/{id}"
