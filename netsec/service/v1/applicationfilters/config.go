...
// []string{"netsec", "service", "v1", "applicationfilters"}
...
import (
	...
	hvvchJA "github.com/paloaltonetworks/sase-go/netsec/schema/objects/application/filters"
)
...
type CreateInput struct {
	Folder string
	Config hvvchJA.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/application-filters
func (c *Client) Create(ctx context.Context, input CreateInput) (hvvchJA.Config, error) {
	// Variables.
	var err error
	var ans hvvchJA.Config
	path := "/sse/config/v1/application-filters"
...
//
// Method: delete
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (hvvchJA.Config, error) {
	// Variables.
	var err error
	var ans hvvchJA.Config
	path := "/sse/config/v1/application-filters/{id}"
...
type ListOutput struct {
	Data   []hvvchJA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]hvvchJA.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]hvvchJA.Config)
	...
	listing := make([]hvvchJA.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (hvvchJA.Config, error) {
	// Variables.
	var err error
	var ans hvvchJA.Config
	path := "/sse/config/v1/application-filters/{id}"
...
// Method: put
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (hvvchJA.Config, error) {
	// Variables.
	var err error
	var ans hvvchJA.Config
	path := "/sse/config/v1/application-filters/{id}"
