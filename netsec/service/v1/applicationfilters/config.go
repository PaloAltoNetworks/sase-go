...
func (c *Client) Create(ctx context.Context, input CreateInput) (lhPcfTR.Config, error) {
	// Variables.
	var err error
	var ans lhPcfTR.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (lhPcfTR.Config, error) {
	// Variables.
	var err error
	var ans lhPcfTR.Config
...
type ListOutput struct {
	Data   []lhPcfTR.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]lhPcfTR.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]lhPcfTR.Config)
	...
	listing := make([]lhPcfTR.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (lhPcfTR.Config, error) {
	// Variables.
	var err error
	var ans lhPcfTR.Config
	path := "/sse/config/v1/application-filters/{id}"
...
// Method: put
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (lhPcfTR.Config, error) {
	// Variables.
	var err error
	var ans lhPcfTR.Config
	path := "/sse/config/v1/application-filters/{id}"
