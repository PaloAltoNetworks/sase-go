...
import (
    ...
    iGNLkdU "github.com/paloaltonetworks/sase-go/netsec/schema/objects/application/filters"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (iGNLkdU.Config, error) {
    // Variables.
    var err error
    var ans iGNLkdU.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (iGNLkdU.Config, error) {
    // Variables.
    var err error
    var ans iGNLkdU.Config
...
type ListOutput struct {
    Data []iGNLkdU.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] iGNLkdU.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] iGNLkdU.Config)
    ...
    listing := make([]iGNLkdU.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (iGNLkdU.Config, error) {
    // Variables.
    var err error
    var ans iGNLkdU.Config
    path := "/sse/config/v1/application-filters/{id}"
...
// Method: put
// URI: /sse/config/v1/application-filters/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (iGNLkdU.Config, error) {
    // Variables.
    var err error
    var ans iGNLkdU.Config
    path := "/sse/config/v1/application-filters/{id}"
