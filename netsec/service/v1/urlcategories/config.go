...
import (
    ...
    wGypUft "github.com/paloaltonetworks/sase-go/netsec/schema/url/categories"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (wGypUft.Config, error) {
    // Variables.
    var err error
    var ans wGypUft.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (wGypUft.Config, error) {
    // Variables.
    var err error
    var ans wGypUft.Config
...
type ListOutput struct {
    Data []wGypUft.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] wGypUft.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] wGypUft.Config)
    ...
    listing := make([]wGypUft.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (wGypUft.Config, error) {
    // Variables.
    var err error
    var ans wGypUft.Config
    path := "/sse/config/v1/url-categories/{id}"
...
// Method: put
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (wGypUft.Config, error) {
    // Variables.
    var err error
    var ans wGypUft.Config
    path := "/sse/config/v1/url-categories/{id}"
