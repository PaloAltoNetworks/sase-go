...
import (
    ...
    hVpQfgV "github.com/paloaltonetworks/sase-go/netsec/schema/url/categories"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (hVpQfgV.Config, error) {
    // Variables.
    var err error
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (hVpQfgV.Config, error) {
    // Variables.
    var err error
    var ans hVpQfgV.Config
...
type ListOutput struct {
    Data []hVpQfgV.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] hVpQfgV.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] hVpQfgV.Config)
    ...
    listing := make([]hVpQfgV.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (hVpQfgV.Config, error) {
    // Variables.
    var err error
    var ans hVpQfgV.Config
    path := "/sse/config/v1/url-categories/{id}"
...
// Method: put
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (hVpQfgV.Config, error) {
    // Variables.
    var err error
    var ans hVpQfgV.Config
    path := "/sse/config/v1/url-categories/{id}"
