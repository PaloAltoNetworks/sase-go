...
// []string{"netsec", "service", "v1", "urlcategories"}
...
import (
	...
	izsGEli "github.com/paloaltonetworks/sase-go/netsec/schema/url/categories"
)
...
type CreateInput struct {
	Folder string
	Config izsGEli.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/url-categories
func (c *Client) Create(ctx context.Context, input CreateInput) (izsGEli.Config, error) {
	// Variables.
	var err error
	var ans izsGEli.Config
	path := "/sse/config/v1/url-categories"
...
//
// Method: delete
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (izsGEli.Config, error) {
	// Variables.
	var err error
	var ans izsGEli.Config
...
type ListOutput struct {
	Data   []izsGEli.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]izsGEli.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]izsGEli.Config)
	...
	listing := make([]izsGEli.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (izsGEli.Config, error) {
	// Variables.
	var err error
	var ans izsGEli.Config
	path := "/sse/config/v1/url-categories/{id}"
...
// Method: put
// URI: /sse/config/v1/url-categories/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (izsGEli.Config, error) {
	// Variables.
	var err error
	var ans izsGEli.Config
	path := "/sse/config/v1/url-categories/{id}"
