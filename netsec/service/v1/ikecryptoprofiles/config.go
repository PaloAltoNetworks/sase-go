...
// []string{"netsec", "service", "v1", "ikecryptoprofiles"}
...
import (
	...
	jgtVIoI "github.com/paloaltonetworks/sase-go/netsec/schema/ike/crypto/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (jgtVIoI.Config, error) {
	// Variables.
	var err error
	var ans jgtVIoI.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (jgtVIoI.Config, error) {
	// Variables.
	var err error
	var ans jgtVIoI.Config
...
type ListOutput struct {
	Data   []jgtVIoI.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]jgtVIoI.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]jgtVIoI.Config)
	...
	listing := make([]jgtVIoI.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ike-crypto-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (jgtVIoI.Config, error) {
	// Variables.
	var err error
	var ans jgtVIoI.Config
	path := "/sse/config/v1/ike-crypto-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ike-crypto-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (jgtVIoI.Config, error) {
	// Variables.
	var err error
	var ans jgtVIoI.Config
	path := "/sse/config/v1/ike-crypto-profiles/{id}"
