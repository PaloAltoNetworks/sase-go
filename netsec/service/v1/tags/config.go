...
func (c *Client) Create(ctx context.Context, input CreateInput) (bHeuEFU.Config, error) {
	// Variables.
	var err error
	var ans bHeuEFU.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (bHeuEFU.Config, error) {
	// Variables.
	var err error
	var ans bHeuEFU.Config
...
type ListOutput struct {
	Data   []bHeuEFU.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]bHeuEFU.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]bHeuEFU.Config)
	...
	listing := make([]bHeuEFU.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/tags/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (bHeuEFU.Config, error) {
	// Variables.
	var err error
	var ans bHeuEFU.Config
	path := "/sse/config/v1/tags/{id}"
...
// Method: put
// URI: /sse/config/v1/tags/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (bHeuEFU.Config, error) {
	// Variables.
	var err error
	var ans bHeuEFU.Config
	path := "/sse/config/v1/tags/{id}"
