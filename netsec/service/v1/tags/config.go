...
import (
	...
	aapvjUr "github.com/paloaltonetworks/sase-go/netsec/schema/objects/tags"
)
...
type CreateInput struct {
	Folder string
	Config aapvjUr.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/tags
func (c *Client) Create(ctx context.Context, input CreateInput) (aapvjUr.Config, error) {
	// Variables.
	var err error
	var ans aapvjUr.Config
	path := "/sse/config/v1/tags"
...
//
// Method: delete
// URI: /sse/config/v1/tags/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (aapvjUr.Config, error) {
	// Variables.
	var err error
	var ans aapvjUr.Config
	path := "/sse/config/v1/tags/{id}"
...
type ListOutput struct {
	Data   []aapvjUr.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]aapvjUr.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]aapvjUr.Config)
	...
	listing := make([]aapvjUr.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/tags/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (aapvjUr.Config, error) {
	// Variables.
	var err error
	var ans aapvjUr.Config
	path := "/sse/config/v1/tags/{id}"
...
// Method: put
// URI: /sse/config/v1/tags/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (aapvjUr.Config, error) {
	// Variables.
	var err error
	var ans aapvjUr.Config
	path := "/sse/config/v1/tags/{id}"
