...
import (
    ...
    mZskfNg "github.com/paloaltonetworks/sase-go/netsec/schema/objects/tags"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (mZskfNg.Config, error) {
    // Variables.
    var err error
    var ans mZskfNg.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (mZskfNg.Config, error) {
    // Variables.
    var err error
    var ans mZskfNg.Config
...
type ListOutput struct {
    Data []mZskfNg.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] mZskfNg.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] mZskfNg.Config)
    ...
    listing := make([]mZskfNg.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/tags/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (mZskfNg.Config, error) {
    // Variables.
    var err error
    var ans mZskfNg.Config
    path := "/sse/config/v1/tags/{id}"
...
// Method: put
// URI: /sse/config/v1/tags/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (mZskfNg.Config, error) {
    // Variables.
    var err error
    var ans mZskfNg.Config
    path := "/sse/config/v1/tags/{id}"
