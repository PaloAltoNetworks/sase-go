...
import (
	...
	vhHaecN "github.com/paloaltonetworks/sase-go/netsec/schema/objects/address/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (vhHaecN.Config, error) {
	// Variables.
	var err error
	var ans vhHaecN.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vhHaecN.Config, error) {
	// Variables.
	var err error
	var ans vhHaecN.Config
...
type ListOutput struct {
	Data   []vhHaecN.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vhHaecN.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vhHaecN.Config)
	...
	listing := make([]vhHaecN.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vhHaecN.Config, error) {
	// Variables.
	var err error
	var ans vhHaecN.Config
	path := "/sse/config/v1/address-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vhHaecN.Config, error) {
	// Variables.
	var err error
	var ans vhHaecN.Config
	path := "/sse/config/v1/address-groups/{id}"
