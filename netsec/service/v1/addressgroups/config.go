...
func (c *Client) Create(ctx context.Context, input CreateInput) (nVitIaG.Config, error) {
	// Variables.
	var err error
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (nVitIaG.Config, error) {
	// Variables.
	var err error
	var ans nVitIaG.Config
...
type ListOutput struct {
	Data   []nVitIaG.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]nVitIaG.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]nVitIaG.Config)
	...
	listing := make([]nVitIaG.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (nVitIaG.Config, error) {
	// Variables.
	var err error
	var ans nVitIaG.Config
	path := "/sse/config/v1/address-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (nVitIaG.Config, error) {
	// Variables.
	var err error
	var ans nVitIaG.Config
	path := "/sse/config/v1/address-groups/{id}"
