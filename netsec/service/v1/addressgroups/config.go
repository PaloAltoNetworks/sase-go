...
// []string{"netsec", "service", "v1", "addressgroups"}
...
import (
    ...
    xiIjTWL "github.com/paloaltonetworks/sase-go/netsec/schema/objects/address/groups"
)
...
type CreateInput struct {
    Folder string
    Config xiIjTWL.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/address-groups
func (c *Client) Create(ctx context.Context, input CreateInput)  (xiIjTWL.Config, error) {
    // Variables.
    var err error
    var ans xiIjTWL.Config
...
//
// Method: delete
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (xiIjTWL.Config, error) {
    // Variables.
    var err error
    var ans xiIjTWL.Config
...
type ListOutput struct {
    Data []xiIjTWL.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] xiIjTWL.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] xiIjTWL.Config)
    ...
    listing := make([]xiIjTWL.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (xiIjTWL.Config, error) {
    // Variables.
    var err error
    var ans xiIjTWL.Config
    path := "/sse/config/v1/address-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/address-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (xiIjTWL.Config, error) {
    // Variables.
    var err error
    var ans xiIjTWL.Config
    path := "/sse/config/v1/address-groups/{id}"
