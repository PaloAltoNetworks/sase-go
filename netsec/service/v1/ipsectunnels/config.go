...
func (c *Client) Create(ctx context.Context, input CreateInput)  (mvZFtQR.Config, error) {
    // Variables.
    var err error
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (mvZFtQR.Config, error) {
    // Variables.
    var err error
    var ans mvZFtQR.Config
...
type ListOutput struct {
    Data []mvZFtQR.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] mvZFtQR.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] mvZFtQR.Config)
    ...
    listing := make([]mvZFtQR.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ipsec-tunnels/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (mvZFtQR.Config, error) {
    // Variables.
    var err error
    var ans mvZFtQR.Config
    path := "/sse/config/v1/ipsec-tunnels/{id}"
...
// Method: put
// URI: /sse/config/v1/ipsec-tunnels/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (mvZFtQR.Config, error) {
    // Variables.
    var err error
    var ans mvZFtQR.Config
    path := "/sse/config/v1/ipsec-tunnels/{id}"
