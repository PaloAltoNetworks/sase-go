...
import (
    ...
    pFtYgGI "github.com/paloaltonetworks/sase-go/netsec/schema/ipsec/tunnels"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (pFtYgGI.Config, error) {
    // Variables.
    var err error
    var ans pFtYgGI.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (pFtYgGI.Config, error) {
    // Variables.
    var err error
    var ans pFtYgGI.Config
...
type ListOutput struct {
    Data []pFtYgGI.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] pFtYgGI.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] pFtYgGI.Config)
    ...
    listing := make([]pFtYgGI.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ipsec-tunnels/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (pFtYgGI.Config, error) {
    // Variables.
    var err error
    var ans pFtYgGI.Config
    path := "/sse/config/v1/ipsec-tunnels/{id}"
...
// Method: put
// URI: /sse/config/v1/ipsec-tunnels/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (pFtYgGI.Config, error) {
    // Variables.
    var err error
    var ans pFtYgGI.Config
    path := "/sse/config/v1/ipsec-tunnels/{id}"
