...
import (
	...
	tsVIFtu "github.com/paloaltonetworks/sase-go/netsec/schema/traffic/steering/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (tsVIFtu.Config, error) {
	// Variables.
	var err error
	var ans tsVIFtu.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (tsVIFtu.Config, error) {
	// Variables.
	var err error
	var ans tsVIFtu.Config
...
type ListOutput struct {
	Data   []tsVIFtu.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]tsVIFtu.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]tsVIFtu.Config)
	...
	listing := make([]tsVIFtu.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/traffic-steering-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (tsVIFtu.Config, error) {
	// Variables.
	var err error
	var ans tsVIFtu.Config
	path := "/sse/config/v1/traffic-steering-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/traffic-steering-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (tsVIFtu.Config, error) {
	// Variables.
	var err error
	var ans tsVIFtu.Config
	path := "/sse/config/v1/traffic-steering-rules/{id}"
