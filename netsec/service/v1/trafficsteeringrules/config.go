...
import (
    ...
    bkeYIoD "github.com/paloaltonetworks/sase-go/netsec/schema/traffic/steering/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (bkeYIoD.Config, error) {
    // Variables.
    var err error
    var ans bkeYIoD.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (bkeYIoD.Config, error) {
    // Variables.
    var err error
    var ans bkeYIoD.Config
...
type ListOutput struct {
    Data []bkeYIoD.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] bkeYIoD.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] bkeYIoD.Config)
    ...
    listing := make([]bkeYIoD.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/traffic-steering-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (bkeYIoD.Config, error) {
    // Variables.
    var err error
    var ans bkeYIoD.Config
    path := "/sse/config/v1/traffic-steering-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/traffic-steering-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (bkeYIoD.Config, error) {
    // Variables.
    var err error
    var ans bkeYIoD.Config
    path := "/sse/config/v1/traffic-steering-rules/{id}"
