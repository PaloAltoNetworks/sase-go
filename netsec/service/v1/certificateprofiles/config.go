...
func (c *Client) Create(ctx context.Context, input CreateInput) (cozuxBy.Config, error) {
	// Variables.
	var err error
	var ans cozuxBy.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (cozuxBy.Config, error) {
	// Variables.
	var err error
	var ans cozuxBy.Config
...
type ListOutput struct {
	Data   []cozuxBy.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]cozuxBy.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]cozuxBy.Config)
	...
	listing := make([]cozuxBy.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (cozuxBy.Config, error) {
	// Variables.
	var err error
	var ans cozuxBy.Config
	path := "/sse/config/v1/certificate-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (cozuxBy.Config, error) {
	// Variables.
	var err error
	var ans cozuxBy.Config
	path := "/sse/config/v1/certificate-profiles/{id}"
