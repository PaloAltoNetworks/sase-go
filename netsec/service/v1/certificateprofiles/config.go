...
// []string{"netsec", "service", "v1", "certificateprofiles"}
...
import (
	...
	mRIvpVj "github.com/paloaltonetworks/sase-go/netsec/schema/certificate/profiles"
)
...
type CreateInput struct {
	Folder string
	Config mRIvpVj.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/certificate-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (mRIvpVj.Config, error) {
	// Variables.
	var err error
	var ans mRIvpVj.Config
	path := "/sse/config/v1/certificate-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mRIvpVj.Config, error) {
	// Variables.
	var err error
	var ans mRIvpVj.Config
	path := "/sse/config/v1/certificate-profiles/{id}"
...
type ListOutput struct {
	Data   []mRIvpVj.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]mRIvpVj.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]mRIvpVj.Config)
	...
	listing := make([]mRIvpVj.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mRIvpVj.Config, error) {
	// Variables.
	var err error
	var ans mRIvpVj.Config
	path := "/sse/config/v1/certificate-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mRIvpVj.Config, error) {
	// Variables.
	var err error
	var ans mRIvpVj.Config
	path := "/sse/config/v1/certificate-profiles/{id}"
