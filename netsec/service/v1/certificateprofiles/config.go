...
func (c *Client) Create(ctx context.Context, input CreateInput)  (ynoZXzd.Config, error) {
    // Variables.
    var err error
    var ans ynoZXzd.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (ynoZXzd.Config, error) {
    // Variables.
    var err error
    var ans ynoZXzd.Config
...
type ListOutput struct {
    Data []ynoZXzd.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] ynoZXzd.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] ynoZXzd.Config)
    ...
    listing := make([]ynoZXzd.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (ynoZXzd.Config, error) {
    // Variables.
    var err error
    var ans ynoZXzd.Config
    path := "/sse/config/v1/certificate-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/certificate-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (ynoZXzd.Config, error) {
    // Variables.
    var err error
    var ans ynoZXzd.Config
    path := "/sse/config/v1/certificate-profiles/{id}"
