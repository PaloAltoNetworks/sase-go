...
func (c *Client) Create(ctx context.Context, input CreateInput) (alljvhu.Config, error) {
	// Variables.
	var err error
	var ans alljvhu.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (alljvhu.Config, error) {
	// Variables.
	var err error
	var ans alljvhu.Config
...
type ListOutput struct {
	Data   []alljvhu.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]alljvhu.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]alljvhu.Config)
	...
	listing := make([]alljvhu.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (alljvhu.Config, error) {
	// Variables.
	var err error
	var ans alljvhu.Config
	path := "/sse/config/v1/authentication-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (alljvhu.Config, error) {
	// Variables.
	var err error
	var ans alljvhu.Config
	path := "/sse/config/v1/authentication-profiles/{id}"
