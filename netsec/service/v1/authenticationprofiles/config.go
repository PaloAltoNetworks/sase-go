...
// []string{"netsec", "service", "v1", "authenticationprofiles"}
...
import (
    ...
    tgWibdy "github.com/paloaltonetworks/sase-go/netsec/schema/authentication/profiles"
)
...
type CreateInput struct {
    Folder string
    Config tgWibdy.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/authentication-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (tgWibdy.Config, error) {
    // Variables.
    var err error
    var ans tgWibdy.Config
    path := "/sse/config/v1/authentication-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (tgWibdy.Config, error) {
    // Variables.
    var err error
    var ans tgWibdy.Config
    path := "/sse/config/v1/authentication-profiles/{id}"
...
type ListOutput struct {
    Data []tgWibdy.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] tgWibdy.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] tgWibdy.Config)
    ...
    listing := make([]tgWibdy.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (tgWibdy.Config, error) {
    // Variables.
    var err error
    var ans tgWibdy.Config
    path := "/sse/config/v1/authentication-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (tgWibdy.Config, error) {
    // Variables.
    var err error
    var ans tgWibdy.Config
    path := "/sse/config/v1/authentication-profiles/{id}"
