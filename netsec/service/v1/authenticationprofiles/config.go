...
import (
	...
	jsrvjbE "github.com/paloaltonetworks/sase-go/netsec/schema/authentication/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (jsrvjbE.Config, error) {
	// Variables.
	var err error
	var ans jsrvjbE.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (jsrvjbE.Config, error) {
	// Variables.
	var err error
	var ans jsrvjbE.Config
...
type ListOutput struct {
	Data   []jsrvjbE.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]jsrvjbE.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]jsrvjbE.Config)
	...
	listing := make([]jsrvjbE.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (jsrvjbE.Config, error) {
	// Variables.
	var err error
	var ans jsrvjbE.Config
	path := "/sse/config/v1/authentication-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/authentication-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (jsrvjbE.Config, error) {
	// Variables.
	var err error
	var ans jsrvjbE.Config
	path := "/sse/config/v1/authentication-profiles/{id}"
