...
// []string{"netsec", "service", "v1", "httpheaderprofiles"}
...
import (
	...
	myewLZO "github.com/paloaltonetworks/sase-go/netsec/schema/http/header/profiles"
)
...
// path: []string{}
// query: []string{"folder-noserviceconnection"}
type CreateInput struct {
	Folder string
	Config myewLZO.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/http-header-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (myewLZO.Config, error) {
	// Variables.
	var err error
	var ans myewLZO.Config
	path := "/sse/config/v1/http-header-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (myewLZO.Config, error) {
	// Variables.
	var err error
	var ans myewLZO.Config
	path := "/sse/config/v1/http-header-profiles/{id}"
...
// path: []string{}
// query: []string{"limit-optional", "offset-optional", "name-optional", "folder-noserviceconnection"}
...
type ListOutput struct {
	Data   []myewLZO.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]myewLZO.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]myewLZO.Config)
	...
	listing := make([]myewLZO.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (myewLZO.Config, error) {
	// Variables.
	var err error
	var ans myewLZO.Config
	path := "/sse/config/v1/http-header-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (myewLZO.Config, error) {
	// Variables.
	var err error
	var ans myewLZO.Config
	path := "/sse/config/v1/http-header-profiles/{id}"
