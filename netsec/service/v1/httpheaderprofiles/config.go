...
func (c *Client) Create(ctx context.Context, input CreateInput) (uIPtsLf.Config, error) {
	// Variables.
	var err error
	var ans uIPtsLf.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (uIPtsLf.Config, error) {
	// Variables.
	var err error
	var ans uIPtsLf.Config
...
type ListOutput struct {
	Data   []uIPtsLf.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]uIPtsLf.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]uIPtsLf.Config)
	...
	listing := make([]uIPtsLf.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (uIPtsLf.Config, error) {
	// Variables.
	var err error
	var ans uIPtsLf.Config
	path := "/sse/config/v1/http-header-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (uIPtsLf.Config, error) {
	// Variables.
	var err error
	var ans uIPtsLf.Config
	path := "/sse/config/v1/http-header-profiles/{id}"
