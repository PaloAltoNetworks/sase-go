...
import (
    ...
    ySwCOHN "github.com/paloaltonetworks/sase-go/netsec/schema/http/header/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (ySwCOHN.Config, error) {
    // Variables.
    var err error
    var ans ySwCOHN.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (ySwCOHN.Config, error) {
    // Variables.
    var err error
    var ans ySwCOHN.Config
...
type ListOutput struct {
    Data []ySwCOHN.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] ySwCOHN.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] ySwCOHN.Config)
    ...
    listing := make([]ySwCOHN.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (ySwCOHN.Config, error) {
    // Variables.
    var err error
    var ans ySwCOHN.Config
    path := "/sse/config/v1/http-header-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/http-header-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (ySwCOHN.Config, error) {
    // Variables.
    var err error
    var ans ySwCOHN.Config
    path := "/sse/config/v1/http-header-profiles/{id}"
