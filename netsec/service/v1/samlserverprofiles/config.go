...
import (
	...
	qhxmhcq "github.com/paloaltonetworks/sase-go/netsec/schema/saml/server/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (qhxmhcq.Config, error) {
	// Variables.
	var err error
	var ans qhxmhcq.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (qhxmhcq.Config, error) {
	// Variables.
	var err error
	var ans qhxmhcq.Config
...
type ListOutput struct {
	Data   []qhxmhcq.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]qhxmhcq.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]qhxmhcq.Config)
	...
	listing := make([]qhxmhcq.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (qhxmhcq.Config, error) {
	// Variables.
	var err error
	var ans qhxmhcq.Config
	path := "/sse/config/v1/saml-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (qhxmhcq.Config, error) {
	// Variables.
	var err error
	var ans qhxmhcq.Config
	path := "/sse/config/v1/saml-server-profiles/{id}"
