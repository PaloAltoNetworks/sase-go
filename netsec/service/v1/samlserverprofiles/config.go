...
// []string{"netsec", "service", "v1", "samlserverprofiles"}
...
import (
    ...
    zaMkRTY "github.com/paloaltonetworks/sase-go/netsec/schema/saml/server/profiles"
)
...
type CreateInput struct {
    Folder string
    Config zaMkRTY.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/saml-server-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (zaMkRTY.Config, error) {
    // Variables.
    var err error
    var ans zaMkRTY.Config
    path := "/sse/config/v1/saml-server-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (zaMkRTY.Config, error) {
    // Variables.
    var err error
    var ans zaMkRTY.Config
    path := "/sse/config/v1/saml-server-profiles/{id}"
...
type ListOutput struct {
    Data []zaMkRTY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] zaMkRTY.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] zaMkRTY.Config)
    ...
    listing := make([]zaMkRTY.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (zaMkRTY.Config, error) {
    // Variables.
    var err error
    var ans zaMkRTY.Config
    path := "/sse/config/v1/saml-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (zaMkRTY.Config, error) {
    // Variables.
    var err error
    var ans zaMkRTY.Config
    path := "/sse/config/v1/saml-server-profiles/{id}"
