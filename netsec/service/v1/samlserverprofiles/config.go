...
func (c *Client) Create(ctx context.Context, input CreateInput) (rqJvTac.Config, error) {
	// Variables.
	var err error
	var ans rqJvTac.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (rqJvTac.Config, error) {
	// Variables.
	var err error
	var ans rqJvTac.Config
...
type ListOutput struct {
	Data   []rqJvTac.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]rqJvTac.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]rqJvTac.Config)
	...
	listing := make([]rqJvTac.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (rqJvTac.Config, error) {
	// Variables.
	var err error
	var ans rqJvTac.Config
	path := "/sse/config/v1/saml-server-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/saml-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (rqJvTac.Config, error) {
	// Variables.
	var err error
	var ans rqJvTac.Config
	path := "/sse/config/v1/saml-server-profiles/{id}"
