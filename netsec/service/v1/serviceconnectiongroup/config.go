...
import (
    ...
    zpGIpQa "github.com/paloaltonetworks/sase-go/netsec/schema/service/connection/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (zpGIpQa.Config, error) {
    // Variables.
    var err error
    var ans zpGIpQa.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (zpGIpQa.Config, error) {
    // Variables.
    var err error
    var ans zpGIpQa.Config
...
type ListOutput struct {
    Data []zpGIpQa.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] zpGIpQa.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] zpGIpQa.Config)
    ...
    listing := make([]zpGIpQa.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-connection-group/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (zpGIpQa.Config, error) {
    // Variables.
    var err error
    var ans zpGIpQa.Config
    path := "/sse/config/v1/service-connection-group/{id}"
...
// Method: put
// URI: /sse/config/v1/service-connection-group/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (zpGIpQa.Config, error) {
    // Variables.
    var err error
    var ans zpGIpQa.Config
    path := "/sse/config/v1/service-connection-group/{id}"
