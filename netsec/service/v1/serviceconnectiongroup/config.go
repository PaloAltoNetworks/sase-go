...
import (
	...
	mwjlHko "github.com/paloaltonetworks/sase-go/netsec/schema/service/connection/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (mwjlHko.Config, error) {
	// Variables.
	var err error
	var ans mwjlHko.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mwjlHko.Config, error) {
	// Variables.
	var err error
	var ans mwjlHko.Config
...
type ListOutput struct {
	Data   []mwjlHko.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]mwjlHko.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]mwjlHko.Config)
	...
	listing := make([]mwjlHko.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/service-connection-group/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mwjlHko.Config, error) {
	// Variables.
	var err error
	var ans mwjlHko.Config
	path := "/sse/config/v1/service-connection-group/{id}"
...
// Method: put
// URI: /sse/config/v1/service-connection-group/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mwjlHko.Config, error) {
	// Variables.
	var err error
	var ans mwjlHko.Config
	path := "/sse/config/v1/service-connection-group/{id}"
