...
// []string{"netsec", "service", "v1", "decryptionrules"}
...
import (
    ...
    cfTfAKg "github.com/paloaltonetworks/sase-go/netsec/schema/decryption/rules"
)
...
type CreateInput struct {
    Position string
    Folder string
    Config cfTfAKg.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/decryption-rules
func (c *Client) Create(ctx context.Context, input CreateInput)  (cfTfAKg.Config, error) {
    // Variables.
    var err error
    var ans cfTfAKg.Config
    path := "/sse/config/v1/decryption-rules"
...
//
// Method: delete
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (cfTfAKg.Config, error) {
    // Variables.
    var err error
    var ans cfTfAKg.Config
    path := "/sse/config/v1/decryption-rules/{id}"
...
type ListOutput struct {
    Data []cfTfAKg.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] cfTfAKg.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] cfTfAKg.Config)
    ...
    listing := make([]cfTfAKg.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (cfTfAKg.Config, error) {
    // Variables.
    var err error
    var ans cfTfAKg.Config
    path := "/sse/config/v1/decryption-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (cfTfAKg.Config, error) {
    // Variables.
    var err error
    var ans cfTfAKg.Config
    path := "/sse/config/v1/decryption-rules/{id}"
