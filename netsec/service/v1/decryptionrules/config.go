...
import (
	...
	tkehwdI "github.com/paloaltonetworks/sase-go/netsec/schema/decryption/rules"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (tkehwdI.Config, error) {
	// Variables.
	var err error
	var ans tkehwdI.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (tkehwdI.Config, error) {
	// Variables.
	var err error
	var ans tkehwdI.Config
...
type ListOutput struct {
	Data   []tkehwdI.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]tkehwdI.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]tkehwdI.Config)
	...
	listing := make([]tkehwdI.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (tkehwdI.Config, error) {
	// Variables.
	var err error
	var ans tkehwdI.Config
	path := "/sse/config/v1/decryption-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (tkehwdI.Config, error) {
	// Variables.
	var err error
	var ans tkehwdI.Config
	path := "/sse/config/v1/decryption-rules/{id}"
