...
func (c *Client) Create(ctx context.Context, input CreateInput) (fKFKDxk.Config, error) {
	// Variables.
	var err error
	var ans fKFKDxk.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fKFKDxk.Config, error) {
	// Variables.
	var err error
	var ans fKFKDxk.Config
...
type ListOutput struct {
	Data   []fKFKDxk.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]fKFKDxk.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]fKFKDxk.Config)
	...
	listing := make([]fKFKDxk.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fKFKDxk.Config, error) {
	// Variables.
	var err error
	var ans fKFKDxk.Config
	path := "/sse/config/v1/decryption-rules/{id}"
...
// Method: put
// URI: /sse/config/v1/decryption-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fKFKDxk.Config, error) {
	// Variables.
	var err error
	var ans fKFKDxk.Config
	path := "/sse/config/v1/decryption-rules/{id}"
