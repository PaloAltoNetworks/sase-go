...
func (c *Client) Create(ctx context.Context, input CreateInput)  (mtKjwYt.Config, error) {
    // Variables.
    var err error
    var ans mtKjwYt.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (mtKjwYt.Config, error) {
    // Variables.
    var err error
    var ans mtKjwYt.Config
...
type ListOutput struct {
    Data []mtKjwYt.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] mtKjwYt.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] mtKjwYt.Config)
    ...
    listing := make([]mtKjwYt.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (mtKjwYt.Config, error) {
    // Variables.
    var err error
    var ans mtKjwYt.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (mtKjwYt.Config, error) {
    // Variables.
    var err error
    var ans mtKjwYt.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
