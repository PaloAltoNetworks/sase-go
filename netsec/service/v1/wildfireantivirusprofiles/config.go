...
// []string{"netsec", "service", "v1", "wildfireantivirusprofiles"}
...
import (
    ...
    ecKsWTW "github.com/paloaltonetworks/sase-go/netsec/schema/wildfire/anti/virus/profiles"
)
...
type CreateInput struct {
    Folder string
    Config ecKsWTW.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/wildfire-anti-virus-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (ecKsWTW.Config, error) {
    // Variables.
    var err error
    var ans ecKsWTW.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (ecKsWTW.Config, error) {
    // Variables.
    var err error
    var ans ecKsWTW.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
...
type ListOutput struct {
    Data []ecKsWTW.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] ecKsWTW.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] ecKsWTW.Config)
    ...
    listing := make([]ecKsWTW.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (ecKsWTW.Config, error) {
    // Variables.
    var err error
    var ans ecKsWTW.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (ecKsWTW.Config, error) {
    // Variables.
    var err error
    var ans ecKsWTW.Config
    path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
