...
import (
	...
	gbvBurS "github.com/paloaltonetworks/sase-go/netsec/schema/wildfire/anti/virus/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (gbvBurS.Config, error) {
	// Variables.
	var err error
	var ans gbvBurS.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (gbvBurS.Config, error) {
	// Variables.
	var err error
	var ans gbvBurS.Config
...
type ListOutput struct {
	Data   []gbvBurS.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]gbvBurS.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]gbvBurS.Config)
	...
	listing := make([]gbvBurS.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (gbvBurS.Config, error) {
	// Variables.
	var err error
	var ans gbvBurS.Config
	path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/wildfire-anti-virus-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (gbvBurS.Config, error) {
	// Variables.
	var err error
	var ans gbvBurS.Config
	path := "/sse/config/v1/wildfire-anti-virus-profiles/{id}"
