...
import (
    ...
    vSTPdMj "github.com/paloaltonetworks/sase-go/netsec/schema/objects/applications"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (vSTPdMj.Config, error) {
    // Variables.
    var err error
    var ans vSTPdMj.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (vSTPdMj.Config, error) {
    // Variables.
    var err error
    var ans vSTPdMj.Config
...
type ListOutput struct {
    Data []vSTPdMj.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] vSTPdMj.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] vSTPdMj.Config)
    ...
    listing := make([]vSTPdMj.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/applications/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (vSTPdMj.Config, error) {
    // Variables.
    var err error
    var ans vSTPdMj.Config
    path := "/sse/config/v1/applications/{id}"
...
// Method: put
// URI: /sse/config/v1/applications/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (vSTPdMj.Config, error) {
    // Variables.
    var err error
    var ans vSTPdMj.Config
    path := "/sse/config/v1/applications/{id}"
