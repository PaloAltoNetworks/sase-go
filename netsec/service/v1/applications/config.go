...
// []string{"netsec", "service", "v1", "applications"}
...
import (
	...
	cJONcvY "github.com/paloaltonetworks/sase-go/netsec/schema/objects/applications"
)
...
type CreateInput struct {
	Folder string
	Config cJONcvY.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/applications
func (c *Client) Create(ctx context.Context, input CreateInput) (cJONcvY.Config, error) {
	// Variables.
	var err error
	var ans cJONcvY.Config
	path := "/sse/config/v1/applications"
...
//
// Method: delete
// URI: /sse/config/v1/applications/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (cJONcvY.Config, error) {
	// Variables.
	var err error
	var ans cJONcvY.Config
	path := "/sse/config/v1/applications/{id}"
...
type ListOutput struct {
	Data   []cJONcvY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]cJONcvY.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]cJONcvY.Config)
	...
	listing := make([]cJONcvY.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/applications/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (cJONcvY.Config, error) {
	// Variables.
	var err error
	var ans cJONcvY.Config
	path := "/sse/config/v1/applications/{id}"
...
// Method: put
// URI: /sse/config/v1/applications/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (cJONcvY.Config, error) {
	// Variables.
	var err error
	var ans cJONcvY.Config
	path := "/sse/config/v1/applications/{id}"
