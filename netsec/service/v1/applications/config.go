...
func (c *Client) Create(ctx context.Context, input CreateInput) (hIzciTY.Config, error) {
	// Variables.
	var err error
	var ans hIzciTY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (hIzciTY.Config, error) {
	// Variables.
	var err error
	var ans hIzciTY.Config
...
type ListOutput struct {
	Data   []hIzciTY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]hIzciTY.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]hIzciTY.Config)
	...
	listing := make([]hIzciTY.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/applications/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (hIzciTY.Config, error) {
	// Variables.
	var err error
	var ans hIzciTY.Config
	path := "/sse/config/v1/applications/{id}"
...
// Method: put
// URI: /sse/config/v1/applications/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (hIzciTY.Config, error) {
	// Variables.
	var err error
	var ans hIzciTY.Config
	path := "/sse/config/v1/applications/{id}"
