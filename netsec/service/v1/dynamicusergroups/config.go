...
// []string{"netsec", "service", "v1", "dynamicusergroups"}
...
import (
    ...
    qoQbnuJ "github.com/paloaltonetworks/sase-go/netsec/schema/objects/dynamic/user/groups"
)
...
type CreateInput struct {
    Folder string
    Config qoQbnuJ.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/dynamic-user-groups
func (c *Client) Create(ctx context.Context, input CreateInput)  (qoQbnuJ.Config, error) {
    // Variables.
    var err error
    var ans qoQbnuJ.Config
    path := "/sse/config/v1/dynamic-user-groups"
...
//
// Method: delete
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (qoQbnuJ.Config, error) {
    // Variables.
    var err error
    var ans qoQbnuJ.Config
    path := "/sse/config/v1/dynamic-user-groups/{id}"
...
type ListOutput struct {
    Data []qoQbnuJ.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] qoQbnuJ.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] qoQbnuJ.Config)
    ...
    listing := make([]qoQbnuJ.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (qoQbnuJ.Config, error) {
    // Variables.
    var err error
    var ans qoQbnuJ.Config
    path := "/sse/config/v1/dynamic-user-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (qoQbnuJ.Config, error) {
    // Variables.
    var err error
    var ans qoQbnuJ.Config
    path := "/sse/config/v1/dynamic-user-groups/{id}"
