...
func (c *Client) Create(ctx context.Context, input CreateInput) (vTBpxry.Config, error) {
	// Variables.
	var err error
	var ans vTBpxry.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (vTBpxry.Config, error) {
	// Variables.
	var err error
	var ans vTBpxry.Config
...
type ListOutput struct {
	Data   []vTBpxry.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]vTBpxry.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]vTBpxry.Config)
	...
	listing := make([]vTBpxry.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (vTBpxry.Config, error) {
	// Variables.
	var err error
	var ans vTBpxry.Config
	path := "/sse/config/v1/dynamic-user-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (vTBpxry.Config, error) {
	// Variables.
	var err error
	var ans vTBpxry.Config
	path := "/sse/config/v1/dynamic-user-groups/{id}"
