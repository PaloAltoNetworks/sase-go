...
import (
	...
	hxiwwhY "github.com/paloaltonetworks/sase-go/netsec/schema/objects/dynamic/user/groups"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (hxiwwhY.Config, error) {
	// Variables.
	var err error
	var ans hxiwwhY.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (hxiwwhY.Config, error) {
	// Variables.
	var err error
	var ans hxiwwhY.Config
...
type ListOutput struct {
	Data   []hxiwwhY.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]hxiwwhY.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]hxiwwhY.Config)
	...
	listing := make([]hxiwwhY.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (hxiwwhY.Config, error) {
	// Variables.
	var err error
	var ans hxiwwhY.Config
	path := "/sse/config/v1/dynamic-user-groups/{id}"
...
// Method: put
// URI: /sse/config/v1/dynamic-user-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (hxiwwhY.Config, error) {
	// Variables.
	var err error
	var ans hxiwwhY.Config
	path := "/sse/config/v1/dynamic-user-groups/{id}"
