...
func (c *Client) Create(ctx context.Context, input CreateInput)  (sRAOviP.Config, error) {
    // Variables.
    var err error
    var ans sRAOviP.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (sRAOviP.Config, error) {
    // Variables.
    var err error
    var ans sRAOviP.Config
...
type ListOutput struct {
    Data []sRAOviP.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] sRAOviP.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] sRAOviP.Config)
    ...
    listing := make([]sRAOviP.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (sRAOviP.Config, error) {
    // Variables.
    var err error
    var ans sRAOviP.Config
    path := "/sse/config/v1/external-dynamic-lists/{id}"
...
// Method: put
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (sRAOviP.Config, error) {
    // Variables.
    var err error
    var ans sRAOviP.Config
    path := "/sse/config/v1/external-dynamic-lists/{id}"
