...
// []string{"netsec", "service", "v1", "externaldynamiclists"}
...
import (
	...
	eyikRvX "github.com/paloaltonetworks/sase-go/netsec/schema/objects/external/dynamic/lists"
)
...
type CreateInput struct {
	Folder string
	Config eyikRvX.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/external-dynamic-lists
func (c *Client) Create(ctx context.Context, input CreateInput) (eyikRvX.Config, error) {
	// Variables.
	var err error
	var ans eyikRvX.Config
	path := "/sse/config/v1/external-dynamic-lists"
...
//
// Method: delete
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (eyikRvX.Config, error) {
	// Variables.
	var err error
	var ans eyikRvX.Config
	path := "/sse/config/v1/external-dynamic-lists/{id}"
...
type ListOutput struct {
	Data   []eyikRvX.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]eyikRvX.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]eyikRvX.Config)
	...
	listing := make([]eyikRvX.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (eyikRvX.Config, error) {
	// Variables.
	var err error
	var ans eyikRvX.Config
	path := "/sse/config/v1/external-dynamic-lists/{id}"
...
// Method: put
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (eyikRvX.Config, error) {
	// Variables.
	var err error
	var ans eyikRvX.Config
	path := "/sse/config/v1/external-dynamic-lists/{id}"
