...
import (
    ...
    jlakzDA "github.com/paloaltonetworks/sase-go/netsec/schema/objects/external/dynamic/lists"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput)  (jlakzDA.Config, error) {
    // Variables.
    var err error
    var ans jlakzDA.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (jlakzDA.Config, error) {
    // Variables.
    var err error
    var ans jlakzDA.Config
...
type ListOutput struct {
    Data []jlakzDA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] jlakzDA.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] jlakzDA.Config)
    ...
    listing := make([]jlakzDA.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (jlakzDA.Config, error) {
    // Variables.
    var err error
    var ans jlakzDA.Config
    path := "/sse/config/v1/external-dynamic-lists/{id}"
...
// Method: put
// URI: /sse/config/v1/external-dynamic-lists/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (jlakzDA.Config, error) {
    // Variables.
    var err error
    var ans jlakzDA.Config
    path := "/sse/config/v1/external-dynamic-lists/{id}"
