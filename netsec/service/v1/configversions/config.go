...
import (
	...
	hCzlSur "github.com/paloaltonetworks/sase-go/netsec/schema/candidate/config/versions"
	zajohll "github.com/paloaltonetworks/sase-go/netsec/schema/load/config"
)
...
func (c *Client) ConfigVersionsGet(ctx context.Context, input ConfigVersionsGetInput) (hCzlSur.Config, error) {
	// Variables.
	var err error
	var ans hCzlSur.Config
...
func (c *Client) Create(ctx context.Context, input CreateInput) (zajohll.Config, error) {
	// Variables.
	var err error
	var ans zajohll.Config
...
func (c *Client) Read(ctx context.Context, input ReadInput) (hCzlSur.Config, error) {
	// Variables.
	var err error
	var ans hCzlSur.Config
