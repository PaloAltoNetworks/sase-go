...
func (c *Client) Create(ctx context.Context, input CreateInput) (fcnKgqA.Config, error) {
	// Variables.
	var err error
	var ans fcnKgqA.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fcnKgqA.Config, error) {
	// Variables.
	var err error
	var ans fcnKgqA.Config
...
type ListOutput struct {
	Data   []fcnKgqA.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]fcnKgqA.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]fcnKgqA.Config)
	...
	listing := make([]fcnKgqA.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fcnKgqA.Config, error) {
	// Variables.
	var err error
	var ans fcnKgqA.Config
	path := "/sse/config/v1/dns-security-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fcnKgqA.Config, error) {
	// Variables.
	var err error
	var ans fcnKgqA.Config
	path := "/sse/config/v1/dns-security-profiles/{id}"
