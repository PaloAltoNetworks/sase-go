...
// []string{"netsec", "service", "v1", "dnssecurityprofiles"}
...
import (
    ...
    pzMEmlf "github.com/paloaltonetworks/sase-go/netsec/schema/dns/security/profiles"
)
...
type CreateInput struct {
    Folder string
    Config pzMEmlf.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/dns-security-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (pzMEmlf.Config, error) {
    // Variables.
    var err error
    var ans pzMEmlf.Config
    path := "/sse/config/v1/dns-security-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (pzMEmlf.Config, error) {
    // Variables.
    var err error
    var ans pzMEmlf.Config
    path := "/sse/config/v1/dns-security-profiles/{id}"
...
type ListOutput struct {
    Data []pzMEmlf.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] pzMEmlf.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] pzMEmlf.Config)
    ...
    listing := make([]pzMEmlf.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (pzMEmlf.Config, error) {
    // Variables.
    var err error
    var ans pzMEmlf.Config
    path := "/sse/config/v1/dns-security-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (pzMEmlf.Config, error) {
    // Variables.
    var err error
    var ans pzMEmlf.Config
    path := "/sse/config/v1/dns-security-profiles/{id}"
