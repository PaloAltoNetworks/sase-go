...
import (
	...
	zMnVxsO "github.com/paloaltonetworks/sase-go/netsec/schema/dns/security/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (zMnVxsO.Config, error) {
	// Variables.
	var err error
	var ans zMnVxsO.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (zMnVxsO.Config, error) {
	// Variables.
	var err error
	var ans zMnVxsO.Config
...
type ListOutput struct {
	Data   []zMnVxsO.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]zMnVxsO.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]zMnVxsO.Config)
	...
	listing := make([]zMnVxsO.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (zMnVxsO.Config, error) {
	// Variables.
	var err error
	var ans zMnVxsO.Config
	path := "/sse/config/v1/dns-security-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/dns-security-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (zMnVxsO.Config, error) {
	// Variables.
	var err error
	var ans zMnVxsO.Config
	path := "/sse/config/v1/dns-security-profiles/{id}"
