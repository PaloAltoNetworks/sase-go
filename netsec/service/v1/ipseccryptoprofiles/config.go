...
func (c *Client) Create(ctx context.Context, input CreateInput) (bajUiwB.Config, error) {
	// Variables.
	var err error
	var ans bajUiwB.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (bajUiwB.Config, error) {
	// Variables.
	var err error
	var ans bajUiwB.Config
...
type ListOutput struct {
	Data   []bajUiwB.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]bajUiwB.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]bajUiwB.Config)
	...
	listing := make([]bajUiwB.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (bajUiwB.Config, error) {
	// Variables.
	var err error
	var ans bajUiwB.Config
	path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (bajUiwB.Config, error) {
	// Variables.
	var err error
	var ans bajUiwB.Config
	path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
