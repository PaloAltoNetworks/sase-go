...
// []string{"netsec", "service", "v1", "ipseccryptoprofiles"}
...
import (
    ...
    hdVfIxM "github.com/paloaltonetworks/sase-go/netsec/schema/ipsec/crypto/profiles"
)
...
type CreateInput struct {
    Folder string
    Config hdVfIxM.Config
}

// Create creates the specified object.
//
// Method: post
// URI: /sse/config/v1/ipsec-crypto-profiles
func (c *Client) Create(ctx context.Context, input CreateInput)  (hdVfIxM.Config, error) {
    // Variables.
    var err error
    var ans hdVfIxM.Config
    path := "/sse/config/v1/ipsec-crypto-profiles"
...
//
// Method: delete
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput)  (hdVfIxM.Config, error) {
    // Variables.
    var err error
    var ans hdVfIxM.Config
    path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
...
type ListOutput struct {
    Data []hdVfIxM.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
    var ans ListOutput
    var err error
    var items map[string] hdVfIxM.Config
    ...
    for {
        ...
        total := int(ans.Total)
        items = make(map[string] hdVfIxM.Config)
    ...
    listing := make([]hdVfIxM.Config, 0, len(items))
    for key := range items {
...
// Method: get
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput)  (hdVfIxM.Config, error) {
    // Variables.
    var err error
    var ans hdVfIxM.Config
    path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput)  (hdVfIxM.Config, error) {
    // Variables.
    var err error
    var ans hdVfIxM.Config
    path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
