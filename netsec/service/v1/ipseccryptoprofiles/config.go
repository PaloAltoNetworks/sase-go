...
import (
	...
	fvMWbSk "github.com/paloaltonetworks/sase-go/netsec/schema/ipsec/crypto/profiles"
)
...
func (c *Client) Create(ctx context.Context, input CreateInput) (fvMWbSk.Config, error) {
	// Variables.
	var err error
	var ans fvMWbSk.Config
...
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fvMWbSk.Config, error) {
	// Variables.
	var err error
	var ans fvMWbSk.Config
...
type ListOutput struct {
	Data   []fvMWbSk.Config `json:"data,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var ans ListOutput
	var err error
	var items map[string]fvMWbSk.Config
	...
	for {
		...
		total := int(ans.Total)
		items = make(map[string]fvMWbSk.Config)
	...
	listing := make([]fvMWbSk.Config, 0, len(items))
	for key := range items {
...
// Method: get
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fvMWbSk.Config, error) {
	// Variables.
	var err error
	var ans fvMWbSk.Config
	path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
...
// Method: put
// URI: /sse/config/v1/ipsec-crypto-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fvMWbSk.Config, error) {
	// Variables.
	var err error
	var ans fvMWbSk.Config
	path := "/sse/config/v1/ipsec-crypto-profiles/{id}"
